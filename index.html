...
<head>
    ...
    <style>
       ...
       #voice-selector-container {
        ...
        #project-tag-filter-container, #calendar-tag-filter-container {
            position: relative;
        }
        #tag-filter-dropdown, #calendar-tag-filter-dropdown {
            position: absolute;
            background-color: var(--current-bg-light);
            border: 1px solid var(--current-border-color);
            border-radius: 0.5rem;
        ...
        .plan-feature-list .fa-star {
            color: var(--gold-color);
            margin-right: 0.5em;
        }
        .plan-feature-list .fa-rocket {
            color: var(--urgent-color);
            margin-right: 0.5em;
        }
...
<body class="w-screen overflow-x-hidden dark-theme">
            ...
            <div class="modal-content-body flex-grow overflow-y-auto px-2">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-text-light">
                    ...
                    <div class="plan-card border-2 border-themed rounded-xl p-6 flex flex-col">
                        ...
                        <div class="plan-details">
                            <ul class="space-y-2 mb-4 plan-feature-list">
                                <li><i class="fas fa-check-circle"></i><strong>100 Créditos</strong> de bienvenida al registrarte</li>
                                <li><i class="fas fa-check-circle"></i>Acceso a Workflows básicos</li>
                                <li><i class="fas fa-check-circle"></i>Acceso a <strong>GOAT X</strong> (Chat General)</li>
                                <li><i class="fas fa-check-circle"></i>Historial de chat limitado</li>
                                <li><i class="fas fa-check-circle"></i>Soporte estándar</li>
                           </ul>
                        </div>
                    ...
                    <div class="plan-card border-2 rounded-xl p-6 flex flex-col bg-current-bg-dark plan-card-highlight">
                        ...
                        <div class="plan-details">
                             <ul class="space-y-2 mb-4 plan-feature-list">
                                <li><i class="fas fa-check-circle"></i><strong>1000 Créditos/mes</strong></li>
                                <li><i class="fas fa-check-circle"></i>Acceso a <strong>todos los Workflows</strong>:</li>
                                <li style="padding-left: 3em; text-indent: -1.5em;"><i class="fas fa-tasks text-xs"></i> Asistente de Proyectos</li>
                                <li style="padding-left: 3em; text-indent: -1.5em;"><i class="fas fa-wallet text-xs"></i> Asistente Financiero</li>
                                <li style="padding-left: 3em; text-indent: -1.5em;"><i class="fas fa-book-open text-xs"></i> Bloc de Notas Avanzado</li>
                                <li style="padding-left: 3em; text-indent: -1.5em;"><i class="fas fa-language text-xs"></i> Traductor Profesional</li>
                                <li><i class="fas fa-check-circle"></i>Acceso a <strong>GOAT X PRO</strong> y <strong>Búsqueda Web</strong></li>
                                <li><i class="fas fa-check-circle"></i>Generación de Imágenes con IA</li>
                                <li><i class="fas fa-check-circle"></i>Análisis de PDF e Imágenes</li>
                                <li><i class="fas fa-check-circle"></i>Soporte Prioritario por email</li>
                                <li><i class="fas fa-star"></i>Gamificación: Gana créditos extra</li>
                            </ul>
                         </div>
                    ...
                    <div class="plan-card border-2 border-themed rounded-xl p-6 flex flex-col">
                        ...
                        <div class="plan-details">
                            <ul class="space-y-2 mb-4 plan-feature-list">
                                 <li><i class="fas fa-check-circle"></i><strong>4000 Créditos/mes</strong></li>
                                 <li><i class="fas fa-check-circle"></i>Todo lo del plan <strong>BOOST</strong></li>
                                 <li class="font-bold"><i class="fas fa-rocket"></i>¡Te construimos tu Página Web!</li>
                                 <li><i class="fas fa-star"></i>Consultoría de IA (1 sesión/mes)</li>
                                 <li><i class="fas fa-star"></i>Acceso a Guías y Recursos Premium</li>
                                 <li><i class="fas fa-star"></i>Próximamente: Colaboración en vivo</li>
                                 <li><i class="fas fa-star"></i>Soporte VIP por WhatsApp</li>
                            </ul>
                         </div>
    ...
    <div id="calendar-modal-overlay" class="fixed inset-0 bg-black bg-opacity-70 hidden items-center justify-center z-40 p-4">
        <div id="calendar-modal" class="modal-content rounded-lg w-full max-w-4xl p-6 relative">
             ...
             <div class="flex flex-wrap justify-between items-center mb-4 gap-2">
                ...
                <div id="calendar-tag-filter-container" class="relative">
                    <button id="calendar-tag-filter-btn" class="p-2 rounded-md bg-input text-sm"><i class="fas fa-tag mr-1"></i> <span data-translate-key="filter_tags">Filtrar</span></button>
                    <div id="calendar-tag-filter-dropdown" class="hidden absolute right-0 mt-1 p-2 rounded-md shadow-lg w-48"></div>
                </div>
            </div>
    ...
    <script type="module">
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            // Objeto que contiene todas las traducciones para español e inglés
            const translations = {
                es: {
                    ...
                    add_to_folder: "Mover a Carpeta", // Actualizado para reflejar el uso común
                ...
                en: {
                    ...
                    rename_title: "Rename",
                    delete_title: "Delete",
                    add_to_folder: "Move to Folder", // Actualizado para reflejar el uso común
            ...
            // Constantes para límites de crédito basados en el plan del usuario
            const GUEST_CREDIT_LIMIT = 5;
            const LOGGED_IN_FREE_CREDITS = 100;
            const BOOST_PLAN_CREDIT_LIMIT = 1000;
            const PRO_PLAN_CREDIT_LIMIT = 4000;

            // Costos asociados con los diferentes usos del modelo de IA
            const COSTS = {
                GENERAL: 1, // Costo para el modelo de chat general (ej. GPT-3.5)
                TRANSLATOR: 1, // Costo para el traductor
                SEARCH: 2,  // Costo para el modelo de búsqueda web (ej. Sonar)
                WORKFLOW: 2, // Costo para el uso de un flujo de trabajo específico
                PDF_ANALYSIS: 2, // Costo para el análisis de PDF
                IMAGE_ANALYSIS: 2, // Costo para el análisis de imágenes
                IMAGE_GENERATION: 5, // Costo para la generación de imágenes (ej. DALL-E)
                GPT4O: 3 // Costo para el modelo GPT-4o
            };

            // Mensajes motivacionales para el modal de motivación
            ...
            // Textos de los botones para el modal de motivación
            ...
            if (loadingTextElement) {
                let messageIndex = 0;
                // Inicia el carrusel de mensajes de inmediato
                loadingInterval = setInterval(() => {
                    messageIndex = (messageIndex + 1) % LOADING_MESSAGES.length;
                    loadingTextElement.textContent = LOADING_MESSAGES[messageIndex];
                }, 1500); // Cambia el mensaje cada 1.5 segundos
            }

            // Variables de estado globales para la aplicación
            let state = { chats: {}, projects: {}, structure: [], calendar: {}, notes: [] };
            let gamificationState = {}; // Estado para las características de gamificación
            let currentChatId = null; // ID del chat actualmente seleccionado
            let currentUser = null;
    let currentUserToken = null; // Usuario autenticado actual
            let speechOn = false; // Bandera para la síntesis de voz
            let availableVoices = []; // Lista de voces disponibles para la síntesis de voz
            let selectedVoice = null; // Voz actualmente seleccionada para la síntesis de voz
            let isRecognizing = false; // Bandera para el reconocimiento de voz en progreso
            let selectedImageBase64 = null; // Cadena codificada en Base64 de la imagen cargada
            let selectedPdfText = null; // Texto extraído del PDF cargado
            let micWasOnBeforeSpeaking = false; // Bandera para reiniciar el micrófono después del TTS
            let modalResolve = null; // Resolvedor de promesas para el modal genérico
            let modalKeydownHandler = null; // Para manejar la tecla Enter en los modales
            let isSelectModeActive = false; // Bandera para el modo de selección múltiple de chat
            let chatsToDelete = new Set(); // Conjunto de IDs de chat seleccionados para eliminar
            let currentNoteId = null; // ID de la nota actualmente seleccionada
            let goatXProUsage = 0; // Contador de uso diario para el modelo GPT-4o
            const GOAT_X_PRO_DAILY_LIMIT = 10; // Límite diario para el modelo GPT-4o

            // Configuración de notificaciones predeterminadas, activas por defecto según los requisitos
            ...
            // Estado relacionado con el calendario
            let selectedCalendarDate = dayjs(); // La fecha actualmente seleccionada en el calendario
            let currentCalendarView = 'month'; // Vista actual del calendario (día, semana, mes)
            let activeTagFilter = null; // Filtro para tareas de proyecto por etiqueta
            let motivationInterval = null; // Intervalo para notificaciones de motivación periódicas

            // Mapeo de elementos DOM para un acceso más fácil
            const dom = {};
            const fullDom = {
                ...
                calendarTagFilterBtn: document.getElementById('calendar-tag-filter-btn'),
                calendarTagFilterDropdown: document.getElementById('calendar-tag-filter-dropdown'),
                financialAssistantView: document.getElementById('financial-assistant-view'),
                gamificationBtn: document.getElementById('gamification-btn'), // Este botón no existe en HTML
                ...
                // Elementos DOM del Bloc de Notas
            ...
            // Asignar propiedades de fullDom al objeto 'dom' para mayor comodidad
            Object.assign(dom, fullDom);

            // Puntos de experiencia de gamificación requeridos para cada nivel
            const XP_FOR_LEVEL = [0, 250, 750, 2000, 5000, Infinity];
            // Nombres para cada nivel de gamificación
            const LEVEL_NAMES = ["Iniciador Digital", "Creador de Contenido", "Estratega de Marketing", "CEO Digital", "G.O.A.T."];
            // Definiciones de misiones para gamificación
            const MISSIONS = {
            ...
            // Definiciones de logros para gamificación
            const ACHIEVEMENTS = {
                ...
                'influencer': { id: 'influencer', title: 'Influencer', description: 'Genera 50 publicaciones para redes sociales.', icon: 'fa-bullhorn', xp: 750, credits: 0, reward: 'Un mes de GOAT Boost gratis.' },
                        ...
                        /**
             * Establece el idioma de la aplicación actualizando el contenido de texto basado en los atributos data-translate-key.
             * @param {string} lang - El código de idioma (ej. 'es', 'en').
             */
            function setLanguage(lang) {
                const translationData = translations[lang];
                if (!translationData) return; // Salir si no se encuentran datos de traducción
                dayjs.locale(lang); // Establecer la configuración regional de Day.js para el formato de fecha
                document.querySelectorAll('[data-translate-key]').forEach(el => {
                    const key = el.dataset.translateKey;
                    if (translationData[key]) {
                        const isIconOnlyButton = el.tagName === 'BUTTON' && el.querySelector('i') && !el.querySelector('span');

                        // Manejar diferentes tipos de elementos para la traducción
                        if (el.tagName === 'TEXTAREA' || el.tagName === 'INPUT' || el.tagName === 'SELECT') {
                            ...
                            if (textSpan) {
                                textSpan.textContent = translationData[key]; // Actualizar texto en un span
                            } else if (icon) {
                                // Si hay un icono y texto directamente en el elemento
                                let textNode = null;
                                ...
                                if (textNode) {
                                    textNode.textContent = ` ${translationData[key]}`; // Anteponer espacio para icono + texto
                                } else {
                                    el.textContent = translationData[key]; // Actualizar el contenido de texto completo
                                }
                            } else {
                                el.textContent = translationData[key]; // Actualizar el contenido de texto completo
                            }
                ...
                document.documentElement.lang = lang; // Establecer el atributo lang de HTML
                localStorage.setItem('goatify-lang', lang); // Guardar la preferencia de idioma
                renderCalendarView(); // Volver a renderizar el calendario para aplicar los cambios de idioma
                renderSidebar(); // Volver a renderizar la barra lateral para aplicar los cambios de idioma
                renderGamificationModal(); // Volver a renderizar el modal de gamificación
                updateCreditCounter(); // Actualizar el contador de créditos
            }

            /**
             * Actualiza el mensaje del pie de página contextual según el flujo de trabajo activo.
             * @param {string|null} workflowKey - La clave del flujo de trabajo actual, o null para el chat general.
             */
            function updateContextualFooter(workflowKey) {
                if (!dom.contextualFooter) return; // Salir si no se encuentra el elemento del pie de página
                // Mapeo de claves de flujo de trabajo a sus textos descriptivos
                const workflowTexts = {
                ...
                // Determinar la clave basada en el flujo de trabajo proporcionado o el chat/vista actual
            ...
            // API de voz web para el reconocimiento de voz
            const SR = window.SpeechRecognition || window.webkitSpeechRecognition;
            let recognition;

            /**
             * Muestra un modal genérico con contenido y botones personalizables.
             * @param {object} options - Configuración para el modal.
             * @param {string} options.title - El título del modal.
             * @param {string} options.body - El contenido HTML para el cuerpo del modal.
             * @param {string} [options.confirmText='Confirmar'] - Texto para el botón de confirmar.
             * @param {string} [options.cancelText='Cancelar'] - Texto para el botón de cancelar.
             * @param {boolean} [options.showCancel=true] - Si se muestra el botón de cancelar.
             * @param {boolean} [options.showConfirm=true] - Si se muestra el botón de confirmar.
             * @param {Array<object>} [options.extraButtons=[]] - Array de botones extra para añadir.
             * @param {boolean} [options.dangerConfirm=false] - Si es verdadero, hace que el botón de confirmar sea rojo.
             * @returns {Promise<object>} Una promesa que se resuelve con { confirmed: boolean, data: object } cuando el modal se cierra.
             */
            function showModal({ title, body, confirmText = 'Confirmar', cancelText = 'Cancelar', showCancel = true, showConfirm = true, extraButtons = [], dangerConfirm = false }) {
                ...
                // Adjuntar escuchadores de eventos para los botones del modal
                if (showConfirm) {
                    ...
                    }, { once: true }); // Usar once: true para eliminar automáticamente el escuchador después del primer clic
                }
                ...
                extraButtons.forEach(btn => {
                    ...
                    if(buttonElement) {
                        buttonElement.addEventListener('click', (e) => {
                            btn.action(e, modalBody); // Pasar evento y modalBody a la acción del botón extra
                        });
                    }
                });

                // Manejar la pulsación de la tecla Enter en el modal para activar la confirmación
                const confirmButton = dom.genericModal.querySelector('#modal-confirm');
                modalKeydownHandler = (e) => {
                    if (e.key === 'Enter') {
                        if (e.target.tagName !== 'TEXTAREA') { // Evitar que Enter envíe si está en un textarea
                            e.preventDefault();
                            if (confirmButton) {
                                confirmButton.click();
                            }
                ...
                // Devolver una promesa que se resuelve cuando el modal se cierra
                return new Promise(resolve => { modalResolve = resolve; });
            }

            /**
             * Oculta el modal genérico y resuelve su promesa.
             * @param {object} [resolveWith=null] - El valor con el que se resuelve la promesa del modal.
             */
            function hideModal(resolveWith = null) {
                // Eliminar el escuchador de keydown si existe
                if (modalKeydownHandler) {
                    document.removeEventListener('keydown', modalKeydownHandler);
                    modalKeydownHandler = null;
                }
                // Resolver la promesa si está pendiente
                if(modalResolve) {
            ...
            /**
             * Muestra el modal de precios.
             */
            function showPricingModal() {
                dom.pricingModal.classList.remove('hidden');
                dom.pricingModal.classList.add('flex');
                // Añadir un pequeño retraso para que la transición de escala sea visible
                ...
                // Actualizar el botón "Tu Plan Actual" según el plan del usuario
                if (isFree) {
            ...
            function showSettingsModal() {
                ...
                // Rellenar el correo electrónico y el plan del usuario si ha iniciado sesión
                if (currentUser) {
                    ...
                    dom.settingsUpgradePlanBtn.classList.toggle('hidden', userPlan !== 'free'); // Ocultar el botón de actualización si no es gratis
                } else {
                ...
                // Establecer el valor y la visualización del deslizador de tamaño de fuente
                ...
                // Establecer el icono del tema según el tema actual
                ...
                // Establecer el estado del interruptor de notificaciones
            ...
            /**
             * Muestra una notificación en la aplicación en la parte superior central de la pantalla.
             * @param {string} title - El título de la notificación.
             * @param {string} body - El contenido del cuerpo de la notificación.
             * @param {number} [duration=5000] - Duración en milisegundos antes de que la notificación se oculte automáticamente. Establecer en 0 para persistente.
             */
            function showInAppNotification(title, body, duration = 5000) {
                ...
                const closeNotification = (event) => {
                    // Evitar el cierre si se hizo clic en un botón/enlace dentro de la notificación
                    if (event && event.target.closest('button, a')) {
                        return;
                    }
                    if(timer) clearTimeout(timer); // Borrar cualquier temporizador de ocultación automática existente
                    dom.inAppNotification.classList.remove('show');
                    dom.inAppNotification.removeEventListener('click', closeNotification); // Eliminar el escuchador de eventos para evitar múltiples llamadas
                    dom.inAppNotificationClose.removeEventListener('click', closeFromX); // Eliminar el escuchador de eventos para el botón 'X'
                };

                const closeFromX = (event) => {
                    event.stopPropagation(); // Evitar que el clic se propague a la propia notificación
                    closeNotification();
                };
            ...
            /**
             * Activa una notificación push en el dispositivo del usuario a través de una función de Netlify.
             * Requiere que el usuario haya iniciado sesión y esté suscrito a las notificaciones push.
             * @param {string} title - El título de la notificación push.
             * @param {string} body - El contenido del cuerpo de la notificación push.
             */
            ...
            /**
             * Convierte una cadena base64 segura para URL en un Uint8Array.
             * Se utiliza para la conversión de claves públicas VAPID para la API Push.
             * @param {string} base64String - La cadena base64 segura para URL.
             * @returns {Uint8Array} El Uint8Array convertido.
             */
            ...
            /**
             * Registra el Service Worker y suscribe al usuario para las notificaciones push.
             * Maneja las solicitudes de permisos y envía los detalles de la suscripción al backend.
             */
            async function registerServiceWorkerAndSubscribe() {
                // Comprobar si el Service Worker y la API Push son compatibles con el navegador
                if (!('serviceWorker' in navigator && 'PushManager' in window)) {
                    console.warn("Las notificaciones Push no son soportadas en este navegador.");
                    notificationsEnabled = false; // Desactivar las notificaciones si no son compatibles
                    return;
                }
                ...
                try {
                    ...
                    // Solicitar permiso de notificación si aún no se ha concedido
                    ...
                    if (subscription === null) {
                        ...
                        // Clave pública VAPID (reemplazar con su clave real si es diferente)
                        const VAPID_PUBLIC_KEY = 'BJ4v02ExA1Tso9D_s2zXJGXWf_Q-wG2t6RkcuT_k9mLyD_i_Ld16Gq2g4Gf4K_V8A2f4g7J1zX9Z8hE3D4A0f5Y';

                        subscription = await registration.pushManager.subscribe({
                            userVisibleOnly: true, // Requerido para notificaciones visibles para el usuario
                            applicationServerKey: urlBase64ToUint8Array(VAPID_PUBLIC_KEY) // Su clave pública VAPID
                        });
                        console.log('Nueva suscripción creada:', subscription);

                        // Enviar la nueva suscripción a su backend para guardarla
                    ...
                    notificationsEnabled = false; // Desactivar las notificaciones en caso de error
                    if(dom.notificationsToggle) dom.notificationsToggle.checked = false;
                    localStorage.setItem('goatify-notifications-enabled', 'false');
                }
            }
            ...
            /**
             * Muestra un modal de notificación específico de la tarea.
             * @param {string} title - El título de la notificación de la tarea.
             * @param {string} body - El contenido del cuerpo de la notificación de la tarea.
             */
            ...
            /**
             * Muestra el modal del calendario.
             */
            function showCalendarModal() {
                dom.calendarModalOverlay.classList.remove('hidden');
                dom.calendarModalOverlay.classList.add('flex');
                if (!currentCalendarView) currentCalendarView = 'month'; // Por defecto a la vista de mes
                renderCalendarView(); // Renderizar la vista actual del calendario
                updateCalendarTime(); // Actualizar la hora cuando se abre el modal
                updateMiDiaInfo(); // Actualizar la información de "Mi Día" cuando se abre el modal
            }

            /**
             * Oculta el modal del calendario.
             */
            ...
            /**
             * Actualiza la fecha y hora actuales que se muestran en el encabezado del modal del calendario.
             */
            ...
            setInterval(updateCalendarTime, 1000); // Actualizar la hora cada segundo

            /**
             * Actualiza la información de "Mi Día" que se muestra en el modal del calendario.
             * Incluye tareas completadas, pendientes, actividades totales y recuento de créditos.
             */
            function updateMiDiaInfo() {
                ...
                // Contar los mensajes de chat enviados hoy
                ...
                // Calcular las actividades totales (tareas + la mitad de los mensajes de chat para simplificar)
                ...
                // Personalizar el mensaje de bienvenida en el modal
                ...
                // Actualizar varios elementos de visualización en el modal
            ...
            function renderMonthView() {
                dom.calendarDaysGrid.innerHTML = ''; // Limpiar días anteriores
                dom.currentMonthYear.textContent = selectedCalendarDate.format('MMMM YYYY'); // Actualizar la visualización de mes/año
                const startDay = selectedCalendarDate.startOf('month').startOf('isoWeek'); // Obtener el primer día de la semana para el primer día del mes

                // Bucle para renderizar 42 días (6 semanas) para llenar la cuadrícula del calendario
                for (let i = 0; i < 42; i++) {
                    const day = startDay.add(i, 'day');
                    const dayEl = document.createElement('div');
                    dayEl.className = 'calendar-day';
                    dayEl.dataset.date = day.format('YYYY-MM-DD'); // Almacenar la fecha para un fácil acceso

                    dayEl.innerHTML = `<span class="calendar-day-number">${day.date()}</span><div class="calendar-day-tasks"></div>`;

                    // Aplicar clases para el mes actual, otros meses y hoy
                    ...
                    // Renderizar hasta 3 tareas directamente en la celda del día
                    tasksForDay.slice(0, 3).forEach(task => {
                        const taskEl = document.createElement('div');
                        taskEl.className = 'calendar-day-task';
                        taskEl.textContent = task.text;
                        // Establecer el color de fondo según la fuente/etiqueta de la tarea
                        ...
                        taskEl.draggable = true; // Hacer las tareas arrastrables
                    ...
                    // Escuchador de eventos para hacer clic en un día o tarea dentro del día
                    dayEl.addEventListener('click', (e) => {
                        if(e.target.classList.contains('delete-task-icon')) {
                            e.stopPropagation(); // Evitar la propagación al clic del día
                            deleteTask(e.target.dataset.taskId);
                        } else if(e.target === e.currentTarget || e.target.classList.contains('calendar-day-tasks')) {
                             editCalendarTask(null, day.format('YYYY-MM-DD')); // Añadir nueva tarea para el día
                        } else if(e.target.closest('.calendar-day-task')) {
                            const taskEl = e.target.closest('.calendar-day-task');
                            handleTaskClick(taskEl.dataset.taskId, taskEl.dataset.taskSource); // Editar tarea existente
                        }
                    });
                    // Escuchadores de eventos de arrastrar y soltar para los días del calendario
                    ...
                    // Escuchadores de eventos táctiles para tareas arrastrables (para arrastrar y soltar en dispositivos móviles)
            ...
            function renderWeekView() {
                dom.weekDaysContent.innerHTML = ''; // Limpiar el contenido de la semana anterior
                let startOfWeek = selectedCalendarDate.startOf('isoWeek'); // Obtener el inicio de la semana actual

                const endOfWeek = startOfWeek.add(6, 'day');
                dom.currentWeekRange.textContent = `${startOfWeek.format('D MMM')} - ${endOfWeek.format('D MMM, YYYY')}`; // Actualizar la visualización del rango de la semana
            ...
            for (let i = 0; i < 7; i++) {
                    ...
                    daySection.dataset.date = dayKey; // Almacenar la fecha para un fácil acceso

                    // Construir HTML para cada sección del día, incluyendo las tareas
                    ...
                    // Escuchadores de eventos de arrastrar y soltar para las secciones de los días de la semana
                    ...
                    // Escuchador de clics para añadir nueva tarea al día
                ...
                // Adjuntar escuchadores de eventos a los elementos creados dinámicamente
                ...
                dom.weekDaysContent.querySelectorAll('.task-item').forEach(item => {
                    item.addEventListener('dragstart', handleCalendarDragStart); // Hacer las tareas arrastrables
                    item.addEventListener('touchstart', handleTouchStart, {passive: false}); // Arrastre táctil para móvil
                    item.addEventListener('click', (e) => {
                        ...
                        if (e.target.type === 'checkbox') return; // No activar si se hace clic en la casilla de verificación
                        handleTaskClick(item.dataset.taskId, item.dataset.taskSource); // Editar tarea
                     });
                });
                dom.weekDaysContent.querySelectorAll('.add-task-to-day-btn').forEach(btn => {
                    btn.addEventListener('click', (e) => {
                        ...
                        editCalendarTask(null, date); // Añadir nueva tarea a un día específico
                    });
                });
            }
            ...
            function renderDayView() {
                dom.currentDayDisplay.textContent = selectedCalendarDate.format('dddd, D [de] MMMM'); // Actualizar la visualización del día
                dom.dayViewTimeline.innerHTML = ''; // Limpiar el contenido del día anterior
                const tasksForDay = getTasksForDay(selectedCalendarDate.format('YYYY-MM-DD'));

                // Recorrer las 24 horas para crear la línea de tiempo
                for (let hour = 0; hour < 24; hour++) {
                    const hourEl = document.createElement('div');
                    hourEl.className = 'day-view-hour';
                    const hourLabel = (hour < 10 ? '0' : '') + hour + ':00';
                    hourEl.dataset.time = hourLabel.substring(0,2); // Almacenar la hora para el objetivo de soltar
                    ...
                    // Escuchadores de eventos de arrastrar y soltar para las áreas de contenido por hora
                ...
                dom.dayViewTimeline.querySelectorAll('.task-item').forEach(item => {
                    ...
                    item.addEventListener('click', (e) => {
                        ...
                        /**
             * Maneja el clic en un elemento de tarea, redirigiendo a la función de edición adecuada según la fuente de la tarea.
             * @param {string} taskId - El ID de la tarea.
             * @param {string} taskSource - La fuente de la tarea ('Personal' o título del proyecto).
             */
            function handleTaskClick(taskId, taskSource) {
                 if (taskSource === 'Personal') {
                    editCalendarTask(taskId);
                } else {
                    // Encontrar el chat del proyecto asociado con la fuente de la tarea
            ...
            let draggedCalendarTaskId = null; // Almacena el ID de la tarea que se está arrastrando en el calendario
            /**
             * Maneja el inicio de una operación de arrastre para una tarea del calendario.
            ...
            function handleCalendarDragStart(e) {
                ...
                e.dataTransfer.setData('text/plain', draggedCalendarTaskId); // Establecer datos para soltar
                e.dataTransfer.effectAllowed = 'move'; // Especificar el efecto de arrastre permitido
            }

            /**
             * Maneja el evento de soltar para una tarea del calendario en una nueva ranura de fecha/hora.
             * @param {DragEvent} e - El evento de soltar.
             */
            function handleCalendarDrop(e) {
                e.preventDefault();
                e.stopPropagation(); // Evitar que el evento se propague
                e.currentTarget.style.backgroundColor = ''; // Restablecer el color de fondo
                const taskId = e.dataTransfer.getData('text/plain');
                if (!taskId) return;

                const dropZone = e.currentTarget;
                const newDate = dropZone.dataset.date; // Obtener la nueva fecha de la zona de soltar
                let newTime = dropZone.dataset.time || findTask(taskId)?.task?.time || null; // Obtener la nueva hora o mantener la hora anterior

                // Ajustar el formato de la hora si solo se proporciona la hora
                ...
                updateTaskStatus(taskId, updates); // Actualizar la tarea con la nueva fecha/hora
            }

            let touchDragElement = null, ghostElement = null; // Elementos para arrastrar y soltar basados en el tacto
            let startX, startY; // Coordenadas táctiles iniciales para arrastrar
            /**
             * Maneja el inicio de una operación de arrastre basada en el tacto para un elemento.
             * Crea un elemento fantasma para la retroalimentación visual.
             * @param {TouchEvent} e - El evento táctil.
             */
            function handleTouchStart(e) {
                if (e.touches.length !== 1) return; // Solo manejar un solo toque
                const target = e.target.closest('[draggable="true"]');
                if (!target) return;

                touchDragElement = target;

                // Crear un elemento fantasma para la retroalimentación visual durante el arrastre
                ghostElement = touchDragElement.cloneNode(true);
                ghostElement.style.position = 'absolute';
                ghostElement.style.zIndex = '1000';
                ghostElement.style.opacity = '0.7';
                ghostElement.style.pointerEvents = 'none'; // Asegurarse de que el elemento fantasma no interfiera con los eventos táctiles
                ...
                // Añadir escuchadores de touchmove y touchend globalmente
                document.addEventListener('touchmove', handleTouchMove, {passive: false});
                document.addEventListener('touchend', handleTouchEnd);
            }

            /**
             * Maneja el movimiento de una operación de arrastre basada en el tacto.
             * Actualiza la posición del elemento fantasma.
             * @param {TouchEvent} e - El evento táctil.
             */
            function handleTouchMove(e) {
                if (e.touches.length !== 1 || !ghostElement) return;
                e.preventDefault(); // Evitar el desplazamiento durante el arrastre
                const touch = e.touches[0];
            ...
            /**
             * Maneja el final de una operación de arrastre basada en el tacto.
             * Determina el objetivo de soltar y realiza la acción relevante.
             * @param {TouchEvent} e - El evento táctil.
             */
            function handleTouchEnd(e) {
                if (!ghostElement) return;

                ghostElement.style.display = 'none'; // Ocultar el elemento fantasma
                // Determinar el elemento en la posición de soltar
                const dropTarget = document.elementFromPoint(e.changedTouches[0].clientX, e.changedTouches[0].clientY);
                ghostElement.remove(); // Eliminar el elemento fantasma del DOM

                if (dropTarget) {
                    // Encontrar la zona de soltar válida más cercana
                    ...
                    if(dropZone) {
                        const taskId = touchDragElement.dataset.taskId; // Para tareas
                        const itemId = touchDragElement.dataset.id; // Para notas/chats
                        const itemType = touchDragElement.dataset.type; // Para notas/chats

                        // Manejar diferentes tipos de zonas de soltar
                        if (dropZone.classList.contains('kanban-cards')) {
                            ...
                            if (itemId && itemType) {
                                moveItemToProject(itemId, targetProjectId); // Mover chat/nota a la carpeta del proyecto
                            } else if (draggedCalendarTaskId) {
                                console.warn("Arrastrar tarea del calendario al encabezado del proyecto no está completamente definido.");
                            }
                        }
                        else {
                            // Por defecto, actualizar la tarea del calendario
                ...
                // Restablecer el estado de arrastre táctil
            ...
            /**
             * Busca una tarea por su ID, ya sea una tarea de calendario personal o una tarea de proyecto.
             * @param {string} taskId - El ID de la tarea a buscar.
             * @returns {object|null} Un objeto que contiene los detalles de la tarea y su ubicación, o null si no se encuentra.
             */
            function findTask(taskId) {
                if (!taskId) return null;
                // Comprobar las tareas del calendario personal
                ...
                // Comprobar las tareas del proyecto en todos los proyectos y columnas
            ...
            /**
             * Actualiza el estado o las propiedades de una tarea (personal o de proyecto).
             * Maneja el movimiento de tareas entre fechas/columnas si la fecha/estado de finalización cambia.
             * @param {string} taskId - El ID de la tarea a actualizar.
             * @param {object} updates - Un objeto que contiene las propiedades a actualizar.
             */
            function updateTaskStatus(taskId, updates) {
                const found = findTask(taskId);
                if (!found) return; // Tarea no encontrada
                ...
                if (found.type === 'personal') {
                    ...
                    if (oldDate !== newDate) {
                        // Si la fecha cambia, mover la tarea al array de la nueva fecha
                        const taskIndex = state.calendar[oldDate].findIndex(t => t.id === taskId);
                        const [taskToMove] = state.calendar[oldDate].splice(taskIndex, 1);
                        if(state.calendar[oldDate].length === 0) delete state.calendar[oldDate]; // Eliminar el array de días vacío

                        if (!state.calendar[newDate]) state.calendar[newDate] = []; // Crear un nuevo array de días si no existe
                        Object.assign(taskToMove, updates); // Aplicar actualizaciones a la tarea
                        delete taskToMove.date; // Eliminar la propiedad 'date' redundante
                        state.calendar[newDate].push(taskToMove); // Añadir tarea a la nueva fecha
                    } else {
                        delete updates.date; // Eliminar la fecha de las actualizaciones si no cambia
                        Object.assign(task, updates); // Aplicar actualizaciones a la tarea existente
                    }
                }
                else if (found.type === 'project') {
                    const { task, chat } = found;
                    const originalCompleted = task.completed; // Almacenar el estado de finalización original

                    // Si se proporciona 'date' en las actualizaciones, significa que es una dueDate para las tareas del proyecto
                    if (updates.date) {
                        updates.dueDate = updates.date;
                        delete updates.date;
                    }

                    Object.assign(task, updates); // Aplicar actualizaciones a la tarea del proyecto

                    // Si el estado de finalización cambió, mover la tarea entre columnas (ej. a 'hecho' o 'por hacer')
                    if (updates.completed !== undefined && updates.completed !== originalCompleted) {
                        let sourceColumn, taskIndex;
                        // Encontrar la columna de origen de la tarea
                        ...
                        if (sourceColumn) {
                            const [taskToMove] = sourceColumn.tasks.splice(taskIndex, 1); // Eliminar la tarea de la columna de origen
                            if (task.completed) {
                                // Si está completada, mover a la columna 'hecho'
                                ...
                                else sourceColumn.tasks.push(taskToMove); // Si ya está en 'hecho' o no hay columna 'hecho', mantener en su lugar
                            } else {
                                // Si no está completada, mover a la columna 'por hacer'
                                ...
                                else sourceColumn.tasks.push(taskToMove); // Si no está en 'hecho' o no hay columna 'por hacer', mantener en su lugar
                            }
                        }
                    }
                }
                ...
                // Volver a renderizar los componentes de la interfaz de usuario relevantes
            ...
            /**
             * Recupera todas las tareas (personales y de proyecto) para un día determinado.
             * @param {string} dayKey - La cadena de fecha en formato 'YYYY-MM-DD'.
             * @returns {Array<object>} Un array de tareas para el día especificado, ordenadas por hora.
             */
            function getTasksForDay(dayKey) {
                // Obtener tareas personales para el día
                const calendarTasks = (state.calendar[dayKey] || []).map(t => ({...t, text: t.content, source: 'Personal', labels: ['Personal']}));
                const projectTasks = [];

                // --- ESTA ES LA LÓGICA CORREGIDA ---
                // Iterar a través de todos los chats de proyecto para encontrar tareas
                Object.values(state.chats).forEach(chat => {
                    if (chat.projectData && chat.projectData.columns) {
                        chat.projectData.columns.forEach(column => {
                            (column.tasks || []).forEach(task => {
                                // Condición 1: La tarea tiene la fecha de hoy
                                if (task.dueDate === dayKey) {
                                    // Condición 2: No hay filtro activo O la tarea tiene la etiqueta del filtro
                                    const shouldRender = !activeTagFilter || (task.labels && task.labels.includes(activeTagFilter));
                                    if (shouldRender) {
                ...
                // Combinar y ordenar las tareas por hora
                return [...calendarTasks, ...projectTasks].sort((a, b) => (a.time || '23:59').localeCompare(b.time || '23:59'));
            }
            /**
             * Actualiza la insignia de notificación que muestra el recuento de tareas vencidas/pendientes.
             */
            function updateNotificationBadge() {
                 let pendingNotifications = 0;
                const now = dayjs();
                // Iterar a través de todos los días del calendario con tareas
                Object.keys(state.calendar).forEach(dayKey => {
                    const tasksForDay = getTasksForDay(dayKey);
                    tasksForDay.forEach(task => {
                         if (!task.completed) {
                            if (task.time) {
                                // Comprobar si la tarea con hora está vencida
                                const taskDateTime = dayjs(`${dayKey}T${task.time}`);
                                if (taskDateTime.isBefore(now)) {
                                     pendingNotifications++;
                                }
                            } else {
                                // Comprobar si la tarea de todo el día es hoy o en el pasado
                ...
                // Actualizar la visibilidad y el recuento de la insignia
            ...
            /**
             * Comprueba y activa las notificaciones para las tareas que están pendientes.
             * Se ejecuta periódicamente.
             */
            function checkAndNotifyTasks() {
                if (!notificationsEnabled) return; // Salir si las notificaciones están deshabilitadas
                const now = dayjs();
                const todayKey = now.format('YYYY-MM-DD');
                const currentHourMinute = now.format('HH:mm');
                const allTasksToday = getTasksForDay(todayKey);
                allTasksToday.forEach(task => {
                    // Comprobar si la tarea está pendiente ahora y no ha sido notificada en este minuto
                    if (!task.completed && task.time === currentHourMinute && !task.notifiedThisMinute) {
                        ...
                        updateTaskNotifiedFlag(task.id, true); // Marcar como notificado para este minuto
                    }
                });
                // Restablecer la bandera de notificación para las tareas que fueron notificadas en minutos anteriores
                for (const dayKey in state.calendar) {
                ...
                saveState(); // Guardar el estado después de actualizar las banderas de notificación
                updateNotificationBadge(); // Actualizar el recuento de la insignia
            }

            /**
             * Actualiza la bandera 'notifiedThisMinute' para una tarea específica.
             * @param {string} taskId - El ID de la tarea.
             * @param {boolean} isNotified - El nuevo valor para la bandera.
             */
            ...
            /**
             * Renderiza la vista de calendario adecuada (día, semana o mes) según `currentCalendarView`.
             */
            function renderCalendarView() {
                ...
                // Actualizar el estado activo de los botones de alternancia de vista
                ...
                // Llamar a la función de renderizado específica para la vista activa
                ...
                // Renderizar el filtro de etiquetas del calendario
                renderCalendarTagFilter();
            }

            setInterval(checkAndNotifyTasks, 10 * 1000); // Comprobar tareas cada 10 segundos

            /**
             * Inicia la síntesis de voz para el texto dado.
             * Maneja la pausa/reinicio del reconocimiento de voz si está activo.
             * @param {string} text - El texto a hablar.
             * @param {HTMLElement} [element=null] - El elemento que activó la voz (opcional).
             */
            function speak(text, element) {
                if (!text) return;

                if (speechOn) { // Si la voz global está habilitada
                    if (!('speechSynthesis' in window)) return; // Comprobar la compatibilidad con la API SpeechSynthesis
                    speechSynthesis.cancel(); // Detener cualquier voz en curso
                    micWasOnBeforeSpeaking = isRecognizing; // Almacenar el estado del micrófono
                    if (isRecognizing) { recognition.stop(); } // Detener el reconocimiento de voz si está activo
                    // Limpiar etiquetas HTML y formato Markdown del texto
                    const cleanText = text.replace(/<[^>]*>/g, '').replace(/[*_`#~[\]()🔍]|(-{3,})/g, '');
                    const utterance = new SpeechSynthesisUtterance(cleanText);
                    if (selectedVoice) { utterance.voice = selectedVoice; } // Establecer la voz seleccionada
                    utterance.rate = 1.15; // Velocidad de habla ligeramente más rápida
                    utterance.onend = () => {
                        // Reiniciar el reconocimiento de voz si estaba activo antes de hablar
                        if (micWasOnBeforeSpeaking) {
                            if (recognition && !isRecognizing) {
                                try { recognition.start(); } catch(e) { console.error("Error al reiniciar el reconocimiento:", e); }
                            }
                    ...
                    utterance.onerror = (e) => {
                        ...
                        // Reiniciar el reconocimiento de voz incluso en caso de error
                        if (micWasOnBeforeSpeaking) {
                            if (recognition && !isRecognizing) {
                               try { recognition.start(); } catch(e) { console.error("Error al reiniciar el reconocimiento en caso de error:", e); }
                            }
                            micWasOnBeforeSpeaking = false;
                        }
                    }
                    speechSynthesis.speak(utterance);
                } else if (element) { // Si la voz es activada por un elemento específico (ej. icono de altavoz)
            ...
            /**
             * Rellena el menú desplegable del selector de voz con las voces de síntesis de voz disponibles.
             * Filtra las voces en español e inglés y prioriza ciertas voces.
             */
            function populateVoiceList() {
                const setVoices = () => {
                    if (typeof speechSynthesis === 'undefined') { return; }
                    // Filtrar las voces en español e inglés
                    availableVoices = speechSynthesis.getVoices().filter(v => v.lang.startsWith('es-') || v.lang.startsWith('en-'));
                    // Priorizar ciertas voces para una mejor experiencia de usuario
                    ...
                    availableVoices.sort((a, b) => {
                        ...
                        if (aIdx !== bIdx) return aIdx - bIdx; // Ordenar primero por índice preferido
                        return a.name.localeCompare(b.name); // Luego por nombre
                    });

                    if (availableVoices.length > 0) {
                        dom.voiceSelector.innerHTML = ''; // Limpiar las opciones existentes
                        availableVoices.forEach(voice => {
                            const option = document.createElement('option');
                            // Limpiar los nombres de las voces para la visualización
                        ...
                        selectedVoice = availableVoices[0]; // Seleccionar la primera voz disponible por defecto
                        if (selectedVoice) dom.voiceSelector.value = selectedVoice.name;
                    }
                }
                // Escuchar el evento voiceschanged para volver a rellenar si las voces están disponibles más tarde
                if (speechSynthesis.onvoiceschanged !== undefined) {
                    speechSynthesis.onvoiceschanged = setVoices;
                }
                setVoices(); // Llamar inmediatamente para rellenar inicialmente
            }

            /**
             * Determina el modelo de IA a utilizar para una solicitud en función del flujo de trabajo, la presencia de archivos y el plan del usuario.
             * Maneja las restricciones de acceso a "GOAT X PRO" para usuarios gratuitos.
             * @param {string} workflow - El flujo de trabajo actual (ej. 'design-web').
             * @param {boolean} hasFile - Verdadero si hay una imagen o PDF adjunto.
             * @param {string} assistantType - El tipo de asistente ('main', 'project', 'financial', 'notepad', 'translator').
             * @returns {string} El ID del modelo seleccionado.
             */
            function getModelForRequest(workflow, hasFile, assistantType) {
                let selector;
                // Seleccionar el selector de modelo correcto según el tipo de asistente
                switch (assistantType) {
                    ...
                    case 'notepad':
                        ...
                        break;
                    case 'translator':
                        selector = document.getElementById('translator-model-selector');
                        break;
                    default:
                        selector = dom.modelSelector; // Selector de modelo de chat principal
                }

                // Anulaciones de modelos específicos para ciertos flujos de trabajo o tipos de archivo
                if (workflow === "design-web") return "gpt-4o-mini"; // Usar modelo específico para diseño web
                if (hasFile) return "gpt-4o-mini"; // Usar modelo específico para análisis de archivos

                const selectedModel = selector.value;
                // Restringir el acceso a "GOAT X PRO" (gpt-4o) para usuarios gratuitos
                if (selectedModel === 'gpt-4o' && (!currentUser || (currentUser.app_metadata?.plan || 'free') === 'free')) {
                     ...
                     selector.value = 'gpt-3.5-turbo-1106'; // Revertir al modelo predeterminado
            ...
            /**
             * Envía una solicitud a la función de Netlify del backend para obtener una respuesta de IA.
             * @param {string} prompt - La entrada del usuario.
             * @param {Array<object>} history - El historial de chat.
             * @param {string} image - Datos de imagen codificados en Base64 (opcional).
             * @param {string} pdf - Texto PDF extraído (opcional).
             * @param {string} model - El modelo de IA a utilizar.
             * @param {string} workflow - El flujo de trabajo activo (opcional).
             * @param {string} userName - El nombre de usuario.
             * @param {object} financialData - Datos financieros para el asistente financiero (opcional).
             * @param {string} noteContent - Contenido de la nota actual para el asistente del bloc de notas (opcional).
            ...
            async function getAIResponse(prompt, history, image, pdf, model, workflow, userName, financialData = null, noteContent = null) {
                ...
                try {
                    ...
                    throw error;
                        ...
                        /**
             * Calcula el recuento de créditos actual para el usuario.
             * Maneja usuarios invitados y diferentes planes de suscripción, leyendo desde localStorage para persistencia.
             * @returns {object} Un objeto que contiene los créditos restantes, el límite total y el plan.
             */
            function getCreditCount() {
                ...
                // Lógica para usuarios que han iniciado sesión
                ...
                // Reiniciar el uso mensual si es un mes nuevo
                if (usageData.month !== currentMonth) {
                    localStorage.setItem(usageKey, JSON.stringify({ count: 0, month: currentMonth }));
            ...
            /**
             * Deduce créditos según el costo de la operación y el modelo utilizado.
             * Muestra modales para créditos insuficientes o límite diario de GOAT X PRO.
             * Prioriza los créditos del plan, luego los de recompensa. Guarda el uso en localStorage.
             * @param {number} cost - El número de créditos a gastar.
             * @param {string} modelUsed - El ID del modelo utilizado (ej. 'gpt-4o').
             * @returns {boolean} Verdadero si los créditos se gastaron correctamente, falso en caso contrario.
             */
            function spendCredits(cost, modelUsed) {
                // Comprobar el límite diario de GOAT X PRO para usuarios que han iniciado sesión
                if (modelUsed === 'gpt-4o' && currentUser) {
                    ...
                    if (goatXProUsage >= GOAT_X_PRO_DAILY_LIMIT) {
                        showModal({
                            ...
                            // Revertir el selector de modelo a GOAT X si se alcanza el límite
                ...
                const gamCredits = (gamificationState.credits || 0); // Obtener créditos de recompensa

                // Comprobar si los créditos totales disponibles son suficientes
                if (remaining < cost && gamCredits < cost) {
                    const lang = localStorage.getItem('goatify-lang') || 'es';
                    if (!currentUser) {
                         // Mostrar modal de inicio de sesión/actualización para usuarios invitados
                         showModal({
                            ...
                            if (res.confirmed) {
                                netlifyIdentity.open('login'); // Abrir el inicio de sesión de Netlify Identity
                            } else {
                                showPricingModal(); // Mostrar planes de precios
                            }
                        });
                    } else {
                        // Mostrar modal de créditos insuficientes para usuarios que han iniciado sesión
                        showModal({
                ...
                // Priorizar los créditos del plan, luego los créditos de recompensa
                if (remaining >= cost) {
                    if (!currentUser) {
                        // Actualizar el uso de invitados en el almacenamiento local
                        ...
                        // Actualizar el uso mensual del usuario que ha iniciado sesión en el almacenamiento local
                        const usageKey = `usage_monthly_${currentUser.id}`;
                        const currentMonth = dayjs().format('YYYY-MM');
                        let usageData = JSON.parse(localStorage.getItem(usageKey)) || { count: 0, month: '' };
                        if (usageData.month !== currentMonth) {
                            usageData = { count: 0, month: currentMonth }; // Reiniciar para el nuevo mes
                        }
                        usageData.count += cost;
                        localStorage.setItem(usageKey, JSON.stringify(usageData));
                    }
                } else {
                    // Usar créditos de recompensa si los créditos del plan son insuficientes
                    gamificationState.credits -= cost;
                    saveGamificationState(); // Guardar el estado de gamificación actualizado
                ...
                updateCreditCounter(); // Actualizar la visualización de créditos en la interfaz de usuario

                // Incrementar el contador de uso diario de GOAT X PRO
                if (modelUsed === 'gpt-4o' && currentUser) {
                    const today = dayjs().format('YYYY-MM-DD');
            ...
            /**
             * Carga el estado de la aplicación desde el almacenamiento local o el backend (para usuarios que han iniciado sesión).
             * Inicializa los chats predeterminados si no existen.
             */
            async function loadStateForUser() {
                // Ayudante para cargar y analizar JSON de forma segura desde el almacenamiento local
                const loadLocalStorage = (key) => {
                    const saved = localStorage.getItem(key);
                    try {
                        // Validación básica para evitar errores de JSON.parse en datos no válidos
                        ...
                        localStorage.removeItem(key); // Borrar datos corruptos
                    }
                    return {};
                };

                if (!currentUser) {
                    // Cargar el estado para usuarios invitados desde el almacenamiento local
                    ...
                    currentChatId = guestData.currentChatId || null;
                     ...
                     try {
                        // Intentar cargar el estado desde el backend (función de Netlify) para usuarios que han iniciado sesión
 ...
 'Content-Type': 'application/json' },
                        ...
                        // Volver al almacenamiento local si la carga del backend falla
                ...
                // Restaurar el último chat/flujo de trabajo visto desde el almacenamiento local
                ...
                // Asegurarse de que existan todas las propiedades de estado de nivel superior
                ...
                // Asegurarse de que 'notepad-assistant-chat' exista y esté marcado como no eliminable
                if (!state.chats['notepad-assistant-chat']) {
                    state.chats['notepad-assistant-chat'] = {
                        ...
                        isDeletable: false, // No puede ser eliminado por el usuario
                    };
                }
                // Asegurarse de que 'english-teacher-translate-chat' exista y esté marcado como no eliminable
                ...
                // Inicializar el contador de uso de GOAT X PRO para el día actual
                const today = dayjs().format('YYYY-MM-DD');
                const proUsageKey = `goat_x_pro_usage_${currentUser?.id || 'guest'}_${today}`;
                goatXProUsage = parseInt(localStorage.getItem(proUsageKey) || '0');

                // Cargar el estado de gamificación (debe ocurrir antes de renderizar cualquier cosa que dependa de él)
                await loadGamificationState();

                renderSidebar(); // Renderizado inicial de la barra lateral

                const urlParams = new URLSearchParams(window.location.search);
                const chatIdFromUrl = urlParams.get('chat');

                // Lógica para determinar qué chat o vista seleccionar al cargar
                ...
                if (chatToSelect) {
                    selectChat(chatToSelect); // Seleccionar el chat/vista determinado
                } else {
                    resetChatView(); // Volver a la vista predeterminada si no hay nada que seleccionar
                }
            }

            /**
             * Guarda el estado actual de la aplicación en el almacenamiento local y (para usuarios que han iniciado sesión) en el backend.
             */
            async function saveState() {
                ...
                try {
                    localStorage.setItem(key, JSON.stringify(stateData)); // Guardar en el almacenamiento local
                    localStorage.setItem('lastView', currentChatId); // Guardar el último elemento visto

                    if(currentUser) {
                        // Enviar el estado al backend para un almacenamiento persistente (con debounce si es necesario para el rendimiento)
 ...
 'Content-Type': 'application/json' },
                    ...
                    // Implementar un manejo de errores más robusto, quizás una cola para los guardados fallidos
                }
            }

            /**
             * Actualiza los elementos de la interfaz de usuario relacionados con el estado de inicio de sesión y el plan del usuario.
             * Oculta/muestra el inicio de sesión/menú de usuario, personaliza el mensaje de bienvenida y actualiza el selector de modelo.
             */
            function updateUserUI() {
                const goatXProModels = document.querySelectorAll('.goat-x-pro-model');
                if (currentUser) {
                    // Interfaz de usuario del usuario que ha iniciado sesión
                    ...
                    // Mostrar el contenedor del plan de actualización solo si el usuario está en el plan 'gratis'
                    dom.upgradePlanContainer.classList.toggle('hidden', (currentUser.app_metadata?.plan || 'free') !== 'free');
                    goatXProModels.forEach(option => option.disabled = false); // Habilitar GOAT X PRO para usuarios que han iniciado sesión

                } else {
                    // Interfaz de usuario del usuario invitado
                    ...
                    goatXProModels.forEach(option => option.disabled = true); // Desactivar GOAT X PRO para invitados
                }
                updateCreditCounter(); // Siempre actualizar el contador de créditos después de los cambios en la interfaz de usuario del usuario
            }

            /**
             * Actualiza la visualización de los créditos del plan y los créditos de recompensa en el encabezado.
             */
            function updateCreditCounter() {
                ...
                let displayLimit = limit === Infinity ? '∞' : limit; // Mostrar '∞' para créditos ilimitados

                dom.planCreditsDisplay.textContent = `${remaining}/${displayLimit}`;
                dom.rewardCreditsDisplay.textContent = `${gamCredits}`;

                dom.messageCounterWrapper.classList.remove('hidden'); // Asegurarse de que el contador de créditos sea visible
            }


            /**
             * Establece el tema de la aplicación (oscuro o claro).
             * Actualiza las clases del cuerpo y el icono del tema.
             * @param {boolean} isDark - Verdadero para tema oscuro, falso para tema claro.
             */
            function setTheme(isDark) {
                document.body.className = 'w-screen overflow-x-hidden'; // Restablecer la clase para eliminar el tema anterior
                document.body.classList.add(isDark ? 'dark-theme' : 'light-theme'); // Aplicar la nueva clase de tema
                dom.themeIcon.className = `fas fa-${isDark ? 'sun' : 'moon'}`; // Actualizar el icono principal de alternancia de tema
                if (dom.settingsThemeIcon) dom.settingsThemeIcon.className = `fas fa-${isDark ? 'moon' : 'sun'} mr-2`; // Actualizar el icono del tema del modal de configuración
                localStorage.setItem('theme', isDark ? 'dark' : 'light'); // Guardar la preferencia de tema
            }

            /**
             * Alterna la visibilidad y el estado contraído de la barra lateral.
             * @param {boolean} show - Verdadero para mostrar/expandir, falso para ocultar/contraer.
             */
            function toggleSidebar(show) {
                const sidebar = dom.sidebar;
                if (show) {
                    sidebar.classList.add('is-open'); // Para móvil: se desliza
                    sidebar.classList.remove('collapsed'); // Para escritorio: se expande
                    dom.sidebarOverlay.classList.remove('opacity-0', 'pointer-events-none'); // Mostrar superposición en móvil
                    dom.sidebarToggleArrow.querySelector('i').classList.replace('fa-chevron-right', 'fa-chevron-left'); // Actualizar la flecha de alternancia
                } else {
                    sidebar.classList.remove('is-open'); // Para móvil: se desliza hacia afuera
                    dom.sidebarOverlay.classList.add('opacity-0', 'pointer-events-none'); // Ocultar superposición en móvil
                    dom.sidebarToggleArrow.querySelector('i').classList.replace('fa-chevron-left', 'fa-chevron-right'); // Actualizar la flecha de alternancia
                }
            }

            /**
             * Crea una nueva conversación de chat.
             * @param {object} [options={}] - Opciones para el nuevo chat (título, flujo de trabajo, mensajes iniciales, modelo).
             * @returns {string} El ID del chat recién creado.
             */
            function createNewChat(options = {}) {
                const id = 'chat-' + crypto.randomUUID(); // Generar ID único
                ...
                let initialMessages;
                // Establecer mensajes iniciales basados en el flujo de trabajo o predeterminados
                ...
                // Añadir datos específicos del proyecto si es un flujo de trabajo de gestión de proyectos
                if (options.workflow === 'project-management') {
                    state.chats[id].projectData = {
                        ...
                        currentView: 'list' // Vista predeterminada para nuevos proyectos
                    };
                }
                // Añadir datos específicos financieros si es un flujo de trabajo de asistente financiero
                ...
                state.structure.unshift(id); // Añadir nuevo chat a la parte superior de la estructura
                selectChat(id); // Seleccionar el nuevo chat
                saveState(); // Guardar el estado actualizado
                renderSidebar(); // Volver a renderizar la barra lateral para mostrar el nuevo chat
                dom.modelSelector.value = options.model || 'gpt-3.5-turbo-1106'; // Establecer el selector de modelo al modelo del nuevo chat
                if (window.innerWidth < 768) toggleSidebar(false); // Cerrar la barra lateral en móvil
            ...
            /**
             * Selecciona un chat o vista de flujo de trabajo y actualiza la interfaz de usuario en consecuencia.
             * @param {string} chatId - El ID del chat o vista especial a seleccionar.
             */
            function selectChat(chatId) {
                currentChatId = chatId;
                localStorage.setItem('lastView', chatId); // Guardar el último elemento visto
                history.pushState({ chatId }, '', `?chat=${chatId}`); // Actualizar el historial del navegador
                if (isSelectModeActive) return; // No continuar si está en modo de selección

                dom.notepadViewContainer.classList.remove('mobile-editor-active'); // Ocultar el editor móvil si está activo

                // Ocultar todas las vistas de contenido principal inicialmente
                ...
                dom.inputArea.style.display = 'none'; // Ocultar el área de entrada principal por defecto

                if (!chatId) {
                    resetChatView(); // Si no hay ID, restablecer a la vista predeterminada
                    return;
                }

                // Mostrar vista específica basada en chatId
                if (chatId === 'translator-view') {
                    ...
                    if (chatId.startsWith('note-')) {
                        selectNote(chatId); // Seleccionar nota específica
                    } else {
                        // Si se selecciona la aplicación de bloc de notas y no hay una nota específica, seleccionar la primera nota u ocultar el editor
                    ...
                    if (chat.workflow === 'project-management') {
                        ...
                        dom.initialMessageContainer.style.display = 'none'; // Ocultar mensaje de bienvenida
                    }

                    dom.chatTitle.textContent = chat.title; // Actualizar el título del chat en el encabezado
                    dom.mobileChatTitle.textContent = chat.title;
                    dom.modelSelector.value = chat.model || 'gpt-3.5-turbo-1106'; // Establecer el selector de modelo
                    updateContextualFooter(chat.workflow); // Actualizar el mensaje del pie de página
                } else {
                     resetChatView(); // Si no se encuentra el chat, restablecer la vista
                }


                updateActiveChatHighlight(); // Resaltar el chat seleccionado en la barra lateral
                saveState(); // Guardar el estado actual
                if (window.innerWidth < 768) toggleSidebar(false); // Cerrar la barra lateral en móvil
            }

            /**
             * Restablece el área principal del chat al mensaje de bienvenida predeterminado.
             */
            function resetChatView() {
                currentChatId = null;
                localStorage.removeItem('lastView'); // Borrar el último elemento visto
                history.pushState({ chatId: null }, '', window.location.pathname); // Borrar el parámetro de la URL
                dom.chatTitle.textContent = "Goatify IA"; // Restablecer el título del encabezado
                dom.mobileChatTitle.textContent = "Goatify IA";

                // Ocultar todas las vistas específicas
                dom.projectManagementView.style.display = 'none';
                dom.financialAssistantView.style.display = 'none';
                dom.notepadViewContainer.style.display = 'none';
                dom.translatorView.style.display = 'none';

                // Mostrar la vista de chat predeterminada
                dom.chatMessages.style.display = 'block';
                dom.inputArea.style.display = 'flex';
                dom.chatMessages.innerHTML = ''; // Borrar mensajes
                dom.initialMessageContainer.style.display = 'flex'; // Mostrar mensaje de bienvenida

                updateUserUI(); // Actualizar la interfaz de usuario relacionada con el usuario
                updateActiveChatHighlight(); // Borrar el resaltado de la barra lateral
                dom.modelSelector.value = 'gpt-3.5-turbo-1106'; // Restablecer el selector de modelo
                updateContextualFooter(null); // Restablecer el mensaje del pie de página
            }

            /**
             * Añade una burbuja de mensaje a la interfaz de usuario.
             * @param {string} role - El rol del remitente ('user' o 'assistant').
             * @param {string} content - El contenido del mensaje (puede contener Markdown).
             * @param {string} [imageSrc=null] - Fuente de imagen base64 opcional para mostrar.
             * @param {number} messageIndex - El índice del mensaje en el array de mensajes del chat.
             * @param {HTMLElement} container - El elemento DOM al que se adjunta el mensaje.
             * @returns {HTMLElement} El elemento de la burbuja de mensaje creado.
             */
            function addMessageToUI(role, content, imageSrc, messageIndex, container) {
                ...
                // Renderizar contenido Markdown, mostrar puntos suspensivos para el estado de pensamiento
                ...
                // Añadir icono de altavoz para mensajes del asistente
                if (role === 'assistant') {
                ...
                // Añadir botón de edición para mensajes de usuario en el chat principal
                ...
                // Añadir botón de vista previa para contenido de código en mensajes del asistente
                ...
                container.scrollTop = container.scrollHeight; // Desplazarse hacia abajo
                return bubble;
            }

            /**
             * Maneja la edición de un mensaje de usuario en el chat principal.
             * Abre un modal para permitir la edición del contenido del mensaje.
             * @param {number} index - El índice del mensaje en el array de mensajes del chat actual.
             */
            async function handleEditMessage(index) {
                ...
                // Si se confirma y el contenido cambia, actualizar el mensaje y volver a renderizar el chat
            ...
            /**
             * Actualiza el contenido de una burbuja de mensaje existente en la interfaz de usuario.
             * Se utiliza para actualizar las burbujas de "pensando" con la respuesta final de la IA.
             * @param {HTMLElement} bubble - El elemento de la burbuja de mensaje a actualizar.
             * @param {string} content - El nuevo contenido del mensaje (puede contener Markdown).
             * @param {string} [imageSrc=null] - Fuente de imagen base64 opcional para mostrar.
             * @param {HTMLElement} container - El contenedor padre de la burbuja de mensaje.
             */
            function updateMessageInUI(bubble, content, imageSrc, container) {
                ...
                bubble.innerHTML = ''; // Borrar el contenido existente
                 if (imageSrc) {
                    const img = document.createElement('img');
                    img.src = imageSrc;
                    img.className = 'rounded-lg mb-2 max-w-full h-auto';
                ...
                const contentDiv = document.createElement('div');
                contentDiv.className = 'markdown-content';
                contentDiv.innerHTML = marked.parse(content || ""); // Analizar y renderizar Markdown
                ...
                // Añadir botón de vista previa para contenido de código
                const hasCode = /```html|```css|```javascript|<pre|<code/.test(content);
                if (hasCode) {
                    const previewButton = document.createElement('button');
                    previewButton.innerHTML = `<i class="fas fa-eye mr-2"></i>${translations[localStorage.getItem('goatify-lang') || 'es'].preview}`;
                    ...
                    bubble.appendChild(previewButton);
                        ...
                        /**
             * Renderiza el contenido de la barra lateral, incluyendo chats, notas y carpetas de proyectos.
             * Organiza los elementos en función de la `state.structure`.
             */
            function renderSidebar() {
                dom.sidebarContent.innerHTML = ''; // Limpiar chats existentes
                dom.foldersContainer.innerHTML = ''; // Limpiar carpetas existentes
                const fragChats = document.createDocumentFragment(); // Usar fragmentos para el rendimiento
                const fragFolders = document.createDocumentFragment();

                // Crear un mapa de todos los elementos (chats, notas, proyectos) para una búsqueda rápida
                ...
                // Rastrear elementos que aún no están archivados en una carpeta
                const unfiledItems = new Set(state.structure);

                // Renderizar primero las carpetas de proyectos
                Object.values(state.projects).forEach(proj => {
                    const projectEl = createProjectElement(proj.id);
                    fragFolders.appendChild(projectEl);
                    unfiledItems.delete(proj.id); // Eliminar el proyecto de los no archivados
                    (proj.itemIds || []).forEach(childId => unfiledItems.delete(childId)); // Eliminar hijos de los no archivados
                });

                // Renderizar chats y notas no archivados
                ...
                // Adjuntar fragmentos a sus respectivos contenedores
                dom.foldersContainer.appendChild(fragFolders);
                dom.sidebarContent.appendChild(fragChats);
                updateActiveChatHighlight(); // Asegurarse de que el elemento actualmente seleccionado esté resaltado
            }
            /**
             * Crea un elemento DOM para un elemento de chat en la barra lateral.
             * Admite el modo de selección y la interacción regular.
             * @param {string} id - El ID del chat.
             * @param {boolean} isSubItem - Verdadero si el chat es un subelemento dentro de una carpeta.
             * @returns {HTMLElement|DocumentFragment} El elemento de chat creado o un fragmento vacío si el chat no se puede eliminar.
             */
            function createChatItemElement(id, isSubItem = false) {
                const chat = state.chats[id];
                if (!chat || chat.isDeletable === false) return document.createDocumentFragment(); // Omitir chats no eliminables
                ...
                if (isSelectModeActive) {
                    // Renderizar para el modo de selección
                    ...
                    item.addEventListener('click', (e) => {
                        e.preventDefault(); // Evitar la selección de chat predeterminada
                        ...
                        dom.deleteSelectedBtn.disabled = chatsToDelete.size === 0; // Habilitar/deshabilitar el botón de eliminar
                    });
                } else {
                    // Renderizar para el modo de interacción regular
                    const isMobileView = window.innerWidth < 768;
                    const actionsOpacityClass = isMobileView ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'; // Mostrar siempre las acciones en móvil
                    ...
                    item.addEventListener('click', e => {
                        if (!e.target.closest('.chat-item-actions')) { // Solo seleccionar chat si no se hizo clic en los botones de acción
                            e.preventDefault();
                            selectChat(id);
                        }
                    });

                    item.addEventListener('dragstart', e => handleDragStart(e, id)); // Habilitar arrastre para mover elementos
                    ...
                    if (addToFolderBtn) {
                        addToFolderBtn.addEventListener('click', (e) => {
                            e.preventDefault();
                            e.stopPropagation(); // Evitar que el menú desplegable se cierre inmediatamente
                            ...
                            dropdown.classList.toggle('hidden'); // Alternar la visibilidad del menú desplegable actual
                            renderFolderDropdown(id, dropdown); // Rellenar el menú desplegable con carpetas
                        });
                    }
            ...
            /**
             * Crea un elemento DOM para un elemento de nota en la barra lateral.
             * Admite el modo de selección y la interacción regular.
             * @param {string} id - El ID de la nota.
             * @param {boolean} isSubItem - Verdadero si la nota es un subelemento dentro de una carpeta.
             * @returns {HTMLElement|DocumentFragment} El elemento de nota creado o un fragmento vacío si no se encuentra la nota.
             */
                ...
                if (isSelectModeActive) {
                    ...
                    item.addEventListener('click', e => {
                         if (!e.target.closest('.chat-item-actions')) {
                            e.preventDefault();
                            selectChat(id); // Seleccionar la nota
                            if (window.innerWidth < 768) {
                                dom.notepadViewContainer.classList.add('mobile-editor-active'); // Mostrar editor de notas en móvil
                            }
                        }
                    });
            ...
            /**
             * Renderiza el menú desplegable para mover un chat/nota a una carpeta de proyecto.
             * @param {string} itemId - El ID del elemento a mover.
             * @param {HTMLElement} dropdownElement - El elemento contenedor del menú desplegable.
             */
            function renderFolderDropdown(itemId, dropdownElement) {
                dropdownElement.innerHTML = '';
                const folders = Object.values(state.projects);
                // Encontrar la carpeta actual a la que pertenece el elemento
                ...
                folders.forEach(folder => {
                    ...
                    if (folder.id === currentFolderId) {
                        button.disabled = true; // Deshabilitar si ya está en esta carpeta
                        button.classList.add('bg-current-primary', 'text-white');
                    }
                    button.addEventListener('click', (e) => {
                        e.stopPropagation();
                        e.preventDefault(); // Evitar cualquier navegación de enlace padre
                        moveItemToProject(itemId, folder.id); // Mover elemento a la carpeta seleccionada
                        dropdownElement.classList.add('hidden'); // Ocultar menú desplegable
                    });
            ...
            /**
             * Crea un elemento DOM para una carpeta de proyecto en la barra lateral.
             * @param {string} id - El ID del proyecto.
             * @returns {HTMLElement|DocumentFragment} El elemento de proyecto creado o un fragmento vacío si no se encuentra el proyecto.
             */
            function createProjectElement(id) {
                ...
                // Añadir elementos hijos (chats y notas) al contenido del proyecto
                ...
                header.addEventListener('click', e => {
                    if (!e.target.closest('.chat-item-actions')) {
                        ...
                        project.isOpen = isOpen; // Persistir el estado abierto/cerrado
                        saveState();
                    }
                });
                // Escuchadores de arrastrar y soltar para los encabezados de proyecto (para soltar elementos en carpetas)
            ...
            let draggedItemId = null; // ID del elemento que se está arrastrando actualmente
            let currentDragSelection = null; // Almacena los elementos seleccionados si está en modo de selección múltiple
            /**
             * Maneja el inicio de una operación de arrastre para un elemento de la barra lateral (chat o nota).
             * @param {DragEvent} e - El evento de arrastre.
             * @param {string} id - El ID del elemento arrastrado.
             */
            function handleDragStart(e, id) {
                draggedItemId = id;
                e.dataTransfer.effectAllowed = 'move';
                e.dataTransfer.setData('text/plain', id); // Establecer datos de texto sin formato para compatibilidad
                // Si está en modo de selección, transferir todos los elementos seleccionados
            ...
            /**
             * Maneja el evento de arrastre sobre un objetivo de soltar.
             * @param {DragEvent} e - El evento de arrastre.
             * @param {HTMLElement} el - El elemento sobre el que se arrastra.
             */
            function handleDragOver(e, el) { e.preventDefault(); el.classList.add('drag-over'); }
            /**
             * Maneja el evento de arrastre al salir de un objetivo de soltar.
             * @param {DragEvent} e - El evento de arrastre.
             * @param {HTMLElement} el - El elemento que se abandona.
             */
            function handleDragLeave(e, el) { el.classList.remove('drag-over'); }
            /**
             * Maneja el evento de soltar para un elemento de la barra lateral en una carpeta de proyecto.
             * @param {DragEvent} e - El evento de soltar.
             * @param {string} targetProjectId - El ID de la carpeta de proyecto en la que se va a soltar.
             * @param {HTMLElement} targetElement - El elemento del encabezado del proyecto.
             */
            function handleDrop(e, targetProjectId, targetElement) {
                ...
                let itemsToMove = [];
                // Comprobar si se arrastraron varios elementos (desde el modo de selección)
                if (e.dataTransfer.types.includes('application/json')) {
                    try {
                        ...
                        console.error("Error al analizar los datos de arrastre JSON:", error);
                        // Volver a un solo elemento si el análisis JSON falla
                ...
                itemsToMove.forEach(itemId => {
                    if (itemId !== targetProjectId) { // Evitar soltar el elemento en sí mismo
                        moveItemToProject(itemId, targetProjectId);
                    }
                });

                // Salir del modo de selección después de arrastrar/soltar si estaba activo
                if (isSelectModeActive && itemsToMove.length > 0) {
                    toggleSelectMode(false);
                }
            }
            /**
             * Mueve un elemento de chat o nota a una carpeta de proyecto especificada.
             * Si `targetProjectId` es null, el elemento se mueve al nivel superior (no archivado).
             * @param {string} itemId - El ID del elemento a mover.
             * @param {string|null} targetProjectId - El ID de la carpeta de proyecto de destino, o null.
             */
            function moveItemToProject(itemId, targetProjectId = null) {
                // Eliminar el elemento de su ubicación actual en la estructura
                state.structure = state.structure.filter(id => id !== itemId);
                // Eliminar el elemento de cualquier carpeta de proyecto existente
                ...
                if(targetProjectId && state.projects[targetProjectId]){
                    // Añadir el elemento a la carpeta de proyecto de destino
                    ...
                    // Añadir el elemento al nivel superior (no archivado)
                    state.structure.unshift(itemId);
                }

                saveState(); // Guardar el estado actualizado
                renderSidebar(); // Volver a renderizar la barra lateral
                if (currentChatId === itemId) {
                    selectChat(currentChatId); // Volver a seleccionar si era el elemento activo
                }
            }

            /**
             * Renombra un chat, proyecto o elemento de nota.
             * Abre un modal para que el usuario introduzca el nuevo nombre.
             * @param {'chat'|'project'|'note'} type - El tipo de elemento a renombrar.
            ...
            async function renameItem(type, id) {
                ...
                if (result.confirmed && result.data['rename-input'] && result.data['rename-input'].trim()) {
                    ...
                    // Actualizar la interfaz de usuario si el elemento renombrado está actualmente activo
                    ...
                    saveState(); // Guardar el estado actualizado
                    renderSidebar(); // Volver a renderizar la barra lateral para reflejar el nuevo nombre
                }
            }
            /**
             * Elimina un chat, proyecto o elemento de nota.
             * Confirma con el usuario antes de la eliminación, especialmente para proyectos con elementos contenidos.
             * @param {'chat'|'project'|'note'} type - El tipo de elemento a eliminar.
             * @param {string} id - El ID del elemento.
             */
            async function deleteItem(type, id) {
                ...
                const confResult = await showModal({
                    ...
                    dangerConfirm: true // Hacer que el botón de confirmar sea rojo
                });

                if (confResult.confirmed) {
                    const idsToDelete = [id, ...childrenIds]; // Incluir hijos para la eliminación del proyecto
                    idsToDelete.forEach(deleteId => {
                        state.structure = state.structure.filter(i => i !== deleteId); // Eliminar de la estructura principal
                        if (deleteId.startsWith('chat-')) delete state.chats[deleteId]; // Eliminar el objeto de chat
                        if (deleteId.startsWith('note-')) state.notes = state.notes.filter(n => n.id !== deleteId); // Filtrar la nota
                        if (deleteId.startsWith('project-')) delete state.projects[deleteId]; // Eliminar el objeto de proyecto

                        // Eliminar de cualquier otra carpeta de proyecto en la que pueda estar
                        Object.values(state.projects).forEach(p => {
                            if(p.itemIds) p.itemIds = p.itemIds.filter(cid => cid !== deleteId)
                        });

                        // Restablecer la vista actual si el elemento eliminado estaba activo
            ...
            /**
             * Actualiza el resaltado visual del chat/nota actualmente seleccionado en la barra lateral.
             */
            function updateActiveChatHighlight() {
                document.querySelectorAll('.chat-item, .note-item').forEach(item => {
                    ...
                    item.classList.toggle('active', item.dataset.id === currentNoteId); // Para notas en el bloc de notas
                });
            }

            /**
             * Borra los datos de la imagen seleccionada y oculta la vista previa de la imagen.
             */
            function clearImageData() {
                dom.imageUploadInput.value = ''; // Borrar la entrada de archivo
                dom.imagePreviewContainer.classList.add('hidden'); // Ocultar el contenedor de vista previa
                dom.filePreviewArea.style.display = "none"; // Ocultar el área general de vista previa de archivos
                selectedImageBase64 = null; // Borrar los datos de la imagen
            }
            /**
             * Borra los datos del PDF seleccionado y oculta la vista previa del PDF.
             */
            function clearPdfData() {
                dom.pdfUploadInput.value = ''; // Borrar la entrada de archivo
                dom.pdfPreviewContainer.classList.add('hidden'); // Ocultar el contenedor de vista previa
                dom.filePreviewArea.style.display = "none"; // Ocultar el área general de vista previa de archivos
                selectedPdfText = null; // Borrar los datos de texto del PDF
            }
            /**
             * Comprueba si hay algún archivo (imagen o PDF) actualmente seleccionado.
             * @returns {boolean} Verdadero si se selecciona un archivo, falso en caso contrario.
             */
            function hasFile() { return selectedImageBase64 || selectedPdfText; }

            /**
             * Envía un mensaje a la IA.
             * Maneja diferentes tipos de asistentes (principal, proyecto, financiero, bloc de notas, traductor).
             * Gestiona la deducción de créditos, las actualizaciones de la interfaz de usuario y la finalización de misiones.
             * @param {boolean} forceSend - Si se debe forzar el envío incluso si la entrada está vacía (ej. para mensajes solo de archivo).
             * @param {string|null} spokenMessage - Mensaje del reconocimiento de voz (opcional).
             * @param {object} options - Objeto de opciones.
             * @param {string} [options.assistantType='main'] - El tipo de asistente que envía el mensaje.
             */
            async function sendMessage(forceSend = false, spokenMessage = null, { assistantType = 'main' } = {}) {
                ...
                // Determinar qué elemento de entrada, contenedor de mensajes y modelo usar según el tipo de asistente
                switch(assistantType) {
                    case 'project':
                    ...
                    case 'financial':
                        ...
                        financialData = state.chats[currentChatId].financialData; // Pasar datos financieros
                    ...
                    case 'notepad':
                        ...
                        chatIdToUpdate = 'notepad-assistant-chat'; // Siempre usar el chat dedicado del asistente del bloc de notas
                        noteContent = dom.noteContentEditor.innerHTML; // Pasar el contenido de la nota actual
                        modelToUse = getModelForRequest(state.chats[chatIdToUpdate]?.workflow, false, 'notepad');
                        break;
                    case 'translator':
                        inputEl = dom.translatorInputEs;
                        messageContainer = dom.translatorOutputEn; // Caso especial: la salida es directamente al textarea
                        modelToUse = getModelForRequest(null, false, 'translator');
                        break;
                    default:
                        inputEl = dom.msgInput;
                        messageContainer = dom.chatMessages;
                        if (!chatIdToUpdate) chatIdToUpdate = createNewChat({}); // Crear nuevo chat si no hay ninguno seleccionado
                ...
                // No enviar mensajes vacíos a menos que se adjunte un archivo
                if (!userMessage && !selectedImageBase64 && !selectedPdfText) return;

                const currentChat = state.chats[chatIdToUpdate];
                if (!currentChat && assistantType !== 'translator') return; // Asegurarse de que el chat exista para tipos que no son traductores

                // Determinar si se necesita una búsqueda web en función de las palabras clave
                ...
                // Determinar el costo del crédito en función del modelo y los tipos de archivo
                let cost = COSTS.GENERAL;
                if(assistantType === 'translator') cost = COSTS.TRANSLATOR;
                else if(modelToUse === 'sonar') cost = COSTS.SEARCH;
                else if(currentChat && currentChat.workflow) cost = COSTS.WORKFLOW;
                else if(selectedPdfText) cost = COSTS.PDF_ANALYSIS;
                else if(selectedImageBase64) cost = COSTS.IMAGE_ANALYSIS;
                else if(modelToUse === 'gpt-4o') cost = COSTS.GPT4O;

                // Intentar gastar créditos; si no tiene éxito, detener el envío del mensaje
                if (!spendCredits(cost, modelToUse)) return;

                // Renombrar automáticamente el título del chat para nuevos chats generales
                ...
                if (assistantType !== 'translator') {
                    ...
                    currentChat.messages.push({ role: 'user', content: userMessage, image, pdfText: pdf, timestamp: new Date().toISOString() }); // Añadir mensaje de usuario al historial de chat
                    addMessageToUI('user', userMessage, image, currentChat.messages.length - 1, messageContainer); // Mostrar mensaje de usuario
                    thinkingBubble = addMessageToUI('assistant', '…', null, null, messageContainer); // Mostrar indicador de pensamiento
                    inputEl.value = ''; // Borrar el campo de entrada
                    inputEl.style.height = 'auto'; // Restablecer la altura de entrada
                   
                } else {
                    messageContainer.value = '…'; // Mostrar indicador de pensamiento para el traductor
                }


                try {
                    const userNameForCall = currentUser ? (currentUser.user_metadata.full_name || currentUser.email) : 'viajero';
                    // Llamar a la función de IA del backend
                    const responseData = await getAIResponse(userMessage, currentChat?.messages.slice(0, -1), selectedImageBase64, selectedPdfText, modelToUse, currentChat?.workflow, userNameForCall, financialData, noteContent);
                     if(assistantType === 'main') {
                        clearImageData(); // Borrar la vista previa de la imagen
                        clearPdfData(); // Borrar la vista previa del PDF
                }
                    updateCreditCounter(); // Actualizar la visualización de créditos después de la respuesta

                    if (assistantType === 'translator') {
                        messageContainer.value = responseData.reply; // Mostrar la traducción directamente
                    } else {
                        currentChat.messages.push({ role: 'assistant', content: responseData.reply, timestamp: new Date().toISOString() }); // Añadir la respuesta de la IA al historial de chat
                        updateMessageInUI(thinkingBubble, responseData.reply, null, messageContainer); // Actualizar la burbuja de pensamiento con la respuesta real
                        speak(responseData.reply); // Hablar la respuesta de la IA
                    }

                    // Completar la misión de gamificación si corresponde
                    ...
                    // Manejar actualizaciones de proyectos (ej. nuevas tareas de IA)
                    if (assistantType === 'project' && responseData.projectUpdate && responseData.projectUpdate.tasks) {
                        ...
                        renderProjectBoard(chatIdToUpdate); // Volver a renderizar el tablero del proyecto
                    }

                    saveState(); // Guardar el estado actualizado
                } catch (error) {
                     // Mostrar mensaje de error si la respuesta de la IA falla
                     if (assistantType === 'translator') {
            ...
            /**
             * Inicia el proceso de generación de imágenes.
             * Solicita al usuario una descripción y llama al backend para generar la imagen.
             */
            async function generateImage() {
                // Mostrar modal para obtener la descripción de la imagen del usuario
                ...
                if (!result.confirmed || !result.data['img-prompt']) return; // Salir si se cancela o no hay entrada

                // Deducir créditos para la generación de imágenes
                if (!spendCredits(COSTS.IMAGE_GENERATION, 'dall-e-2')) return;

                let chatIdToUpdate = currentChatId || createNewChat({}); // Usar el chat actual o crear uno nuevo
                const currentChat = state.chats[chatIdToUpdate];
                // Añadir la solicitud de generación de imagen del usuario al historial de chat
                ...
                const thinkingBubble = addMessageToUI('assistant', '…', null, null, dom.chatMessages); // Mostrar indicador de pensamiento
                try {
                    ...
                    // Actualizar la burbuja de pensamiento con la imagen generada
                    ...
                    completeMission('image-generated'); // Completar la misión de gamificación
                    saveState(); // Guardar el estado actualizado
                } catch (error) {
                    // Mostrar mensaje de error si la generación de imágenes falla
            ...
            /**
             * Alterna el modo de selección múltiple para chats/notas en la barra lateral.
             * @param {boolean} active - Verdadero para activar el modo de selección, falso para desactivar.
             */
            function toggleSelectMode(active) {
                isSelectModeActive = active;
                dom.selectChatsBtn.classList.toggle('hidden', active); // Ocultar/mostrar el botón de selección
                dom.deleteModeControls.classList.toggle('hidden', !active); // Mostrar/ocultar los controles de eliminación
                if (!active) {
                    chatsToDelete.clear(); // Borrar elementos seleccionados
                    dom.deleteSelectedBtn.disabled = true; // Deshabilitar el botón de eliminar
                }
                renderSidebar(); // Volver a renderizar la barra lateral para aplicar el estilo del modo de selección

                // Añadir/eliminar escuchadores de eventos para la selección de arrastre
                if (active) {
                    ...
                    clearSelectionVisuals(); // Borrar cualquier resaltado visual de selección
                }
            }

            let isDraggingForSelection = false; // Bandera para la selección de arrastre en progreso
            let selectionRect = null; // El elemento del rectángulo de selección visual
            let initialSelectionX = 0; // Coordenada X inicial para la selección de arrastre
            let initialSelectionY = 0; // Coordenada Y inicial para la selección de arrastre

            /**
             * Maneja el evento de presionar el botón del ratón para iniciar la selección de arrastre en la barra lateral.
             * @param {MouseEvent} e - El evento del ratón.
             */
            function handleMouseDownForSelection(e) {
                // Solo iniciar si el botón izquierdo del ratón y el clic están dentro del contenido desplazable de la barra lateral
                ...
                // Crear y estilizar el rectángulo de selección
                ...
                // Añadir escuchadores de mousemove y mouseup globalmente
            ...
            /**
             * Maneja el evento de movimiento del ratón durante la selección de arrastre.
             * Actualiza el tamaño y la posición del rectángulo de selección y resalta los elementos superpuestos.
             * @param {MouseEvent} e - El evento del ratón.
             */
            function handleMouseMoveForSelection(e) {
                ...
                // Obtener todos los elementos seleccionables que aún no están seleccionados
                ...
                allItems.forEach(item => {
                    ...
                    // Comprobar la superposición entre el rectángulo de selección y el elemento
                    const isOverlapping = !(
                    ...
                    if (isOverlapping) {
                        ...
                        // Si el elemento fue seleccionado previamente pero ya no se superpone, deseleccionarlo
                ...
                dom.deleteSelectedBtn.disabled = chatsToDelete.size === 0; // Actualizar el estado del botón de eliminar
            }

            /**
             * Maneja el evento de soltar el botón del ratón después de la selección de arrastre.
             * Limpia el rectángulo de selección y los escuchadores de eventos.
             */
            function handleMouseUpForSelection() {
                ...
                dom.deleteSelectedBtn.disabled = chatsToDelete.size === 0; // Actualización final para el botón de eliminar
            }

            /**
             * Borra todos los resaltados visuales de los elementos seleccionados en la barra lateral.
             */
            ...
            let drawingHistory = []; // Almacena los estados del lienzo para deshacer/rehacer
            let historyIndex = -1; // Posición actual en el historial de dibujo

            /**
             * Guarda el estado actual del lienzo de dibujo en el historial y en la nota activa.
             */
            function saveDrawingState() {
                ...
                // Si el estado actual no es el más reciente, truncar el historial
                ...
                if (activeNote) {
                    activeNote.content = imageData; // Guardar los datos de la imagen en el contenido de la nota
                    saveState();
                }
            }

            /**
             * Deshace la última acción de dibujo en el lienzo.
             */
            function undoDrawing() {
                if (historyIndex > 0) {
                    ...
                    const img = new Image();
                    img.onload = () => {
                        ctx.clearRect(0, 0, canvas.width, canvas.height); // Borrar lienzo
                        ctx.drawImage(img, 0, 0, canvas.width, canvas.height); // Redibujar el estado anterior
                    };
            ...
            /**
             * Rehace la última acción de dibujo deshecha en el lienzo.
             */
            ...
            /**
             * Muestra la vista del Bloc de Notas e inicializa sus componentes.
             * Maneja el diseño específico para móviles del asistente de chat del bloc de notas.
             */
            function showNotepadView() {
                dom.notepadViewContainer.style.display = 'flex';
                // En móvil, siempre comenzar con el asistente contraído
                if (window.innerWidth < 768) {
                    dom.notepadChatContainer.classList.add('collapsed');
                } else {
                    dom.notepadChatContainer.classList.remove('collapsed');
                }
                // Ocultar el contenedor de chat del bloc de notas en móvil inicialmente, se revelará al expandirse
                dom.notepadChatContainer.classList.toggle('hidden', window.innerWidth < 768);


                updateContextualFooter('notepad-app'); // Actualizar el mensaje del pie de página

                const notepadChat = state.chats['notepad-assistant-chat'];
                dom.notepadChatMessages.innerHTML = ''; // Limpiar mensajes existentes
                // Añadir mensajes existentes a la interfaz de usuario del chat del bloc de notas
                notepadChat.messages.forEach((msg, index) => addMessageToUI(msg.role, msg.content, msg.image, index, dom.notepadChatMessages));


                if (state.notes.length === 0) {
                     dom.noteEditorPanel.classList.add('hidden'); // Ocultar editor si no hay notas
                } else if (!currentNoteId || !state.notes.find(n => n.id === currentNoteId)) {
                    selectNote(state.notes[0].id); // Seleccionar la primera nota si no hay ninguna actual
                } else {
                    selectNote(currentNoteId); // Seleccionar la nota actual
                }

                // Deshabilitar la opción GOAT X PRO para usuarios no registrados en el selector de modelo del bloc de notas
            ...
            /**
             * Selecciona una nota específica y la carga en el editor.
             * @param {string} noteId - El ID de la nota a seleccionar.
             */
            function selectNote(noteId) {
                ...
                dom.noteEditorPanel.classList.remove('hidden'); // Mostrar panel del editor
                currentNoteId = noteId;
                loadNoteIntoEditor(noteId); // Cargar contenido de la nota
                updateActiveChatHighlight(); // Resaltar nota seleccionada en la barra lateral
            }

            /**
             * Crea una nueva nota (texto o dibujo) y la añade al estado.
             * @param {'text'|'drawing'} [type='text'] - El tipo de nota a crear.
             */
            function createNewNote(type = 'text') {
                const lang = localStorage.getItem('goatify-lang') || 'es';
                const newNote = {
                    id: 'note-' + crypto.randomUUID(), // Generar ID único
                    title: type === 'text' ? (translations[lang].new_note || 'Nueva Nota') : (translations[lang].new_drawing_title || 'Nuevo Dibujo'),
                    content: type === 'text' ? '' : null, // Contenido inicial según el tipo
                    type: type,
                    createdAt: new Date().toISOString()
                };
                state.notes.unshift(newNote); // Añadir nueva nota al principio del array de notas
                state.structure.unshift(newNote.id); // Añadir a la estructura principal
                saveState(); // Guardar el estado inmediatamente
                renderSidebar(); // Volver a renderizar la barra lateral para mostrar la nueva nota
                selectChat(newNote.id); // Seleccionar la nueva nota para abrirla en el editor

                if (window.innerWidth < 768) {
                    dom.notepadViewContainer.classList.add('mobile-editor-active'); // Mostrar editor en móvil
                }
            ...
            /**
             * Carga el contenido de una nota especificada en el editor o lienzo.
             * @param {string} noteId - El ID de la nota a cargar.
             */
            function loadNoteIntoEditor(noteId) {
                ...
                dom.noteTitleInput.value = note.title; // Establecer título de la nota
                const isDrawing = note.type === 'drawing';

                // Alternar la visibilidad del editor de texto vs. el lienzo
                dom.noteContentEditor.style.display = isDrawing ? 'none' : 'block';
                dom.noteCanvas.style.display = isDrawing ? 'block' : 'none';
                dom.noteContentEditor.innerHTML = isDrawing ? '' : note.content; // Establecer contenido de texto o borrar para dibujar

                // Alternar la visibilidad de las herramientas de texto vs. las herramientas de dibujo
                dom.textTools.style.display = isDrawing ? 'none' : 'flex';
                dom.drawingTools.style.display = isDrawing ? 'flex' : 'none';
                dom.drawingFullscreenBtn.style.display = isDrawing ? 'block' : 'none'; // Mostrar pantalla completa solo para dibujos

                if (isDrawing) {
                    setupCanvas(note); // Inicializar lienzo para dibujar
                } else {
            ...
            /**
             * Configura el lienzo de dibujo para una nota de tipo 'drawing'.
             * Configura las herramientas de dibujo, los escuchadores de eventos y el historial.
             * @param {object} note - El objeto de nota de tipo 'drawing'.
             */
            function setupCanvas(note) {
                ...
                let isDrawing = false; // Bandera para dibujo activo
                let lastX = 0; // Última coordenada X para la ruta de dibujo
                let lastY = 0; // Última coordenada Y para la ruta de dibujo
                let startX = 0; // Coordenada X inicial para formas
                let startY = 0; // Coordenada Y inicial para formas
                let currentTool = 'pencil'; // Herramienta de dibujo activa actual
                let currentSnapshot = null; // Instantánea del lienzo para el dibujo de formas (para redibujar el fondo)

                drawingHistory = []; // Restablecer historial de dibujo
                historyIndex = -1; // Restablecer índice de historial

                // Función para redimensionar el lienzo y redibujar el contenido
                const resizeCanvas = () => {
                    const rect = canvas.parentElement.getBoundingClientRect();
                    canvas.width = rect.width;
                    canvas.height = rect.height;
                    // Redibujar el contenido de los datos de la imagen guardados después de redimensionar
                    if (note.content) {
                        const img = new Image();
                        img.onload = () => {
                            ctx.clearRect(0, 0, canvas.width, canvas.height);
                            ctx.drawImage(img, 0, 0, canvas.width, canvas.height);
                            saveDrawingState(); // Guardar nuevo estado después de redimensionar y redibujar
                        }
                        img.src = note.content;
                    } else {
                        ctx.clearRect(0, 0, canvas.width, canvas.height);
                        saveDrawingState(); // Guardar estado vacío si no hay contenido
                    }
                };

                resizeCanvas(); // Redimensionamiento inicial
                window.removeEventListener('resize', resizeCanvas); // Eliminar el escuchador antiguo para evitar duplicados
                window.addEventListener('resize', resizeCanvas); // Añadir nuevo escuchador de redimensionamiento
                ...
                // Ayudante para obtener coordenadas relativas al lienzo
                const getCoords = (e) => {
                ...
                // Iniciar acción de dibujo
                const startDrawing = (e) => {
                    e.preventDefault();
                    isDrawing = true;
                    [lastX, lastY] = getCoords(e);
                    [startX, startY] = [lastX, lastY]; // Almacenar punto de inicio para formas
                    if (currentTool === 'pencil' || currentTool === 'eraser') {
                         ctx.beginPath(); // Iniciar nueva ruta para dibujo continuo
                         ctx.moveTo(lastX, lastY);
                    } else {
                        currentSnapshot = ctx.getImageData(0, 0, canvas.width, canvas.height); // Guardar estado del lienzo antes de dibujar la forma
                    }
                };
                // Acción de dibujo
                const draw = (e) => {
                    ...
                    ctx.strokeStyle = toolbar.querySelector('#drawing-color').value; // Establecer color del trazo
                    ctx.lineWidth = toolbar.querySelector('#drawing-line-width').value; // Establecer ancho de línea
                    ctx.lineCap = 'round';
                    ctx.lineJoin = 'round';
                    // Establecer la operación de composición para el efecto de borrador
                    ...
                    if (currentTool === 'pencil' || currentTool === 'eraser') {
                        ...
                        ctx.putImageData(currentSnapshot, 0, 0); // Restaurar lienzo a la instantánea
                        ctx.beginPath();
                        if (currentTool === 'line') {
                ...
                const stopDrawing = () => {
                    ...
                    saveDrawingState(); // Guardar el estado actual en el historial
                    currentSnapshot = null; // Borrar instantánea
                };

                // Adjuntar escuchadores de eventos de ratón y táctiles al lienzo
                canvas.onmousedown = startDrawing;
                canvas.onmousemove = draw;
                canvas.onmouseup = stopDrawing;
                canvas.onmouseout = stopDrawing; // Detener el dibujo si el ratón sale del lienzo
                canvas.ontouchstart = startDrawing;
                canvas.ontouchmove = draw;
                canvas.ontouchend = stopDrawing;

                // Ayudante para establecer la herramienta activa y actualizar la interfaz de usuario
                ...
                // Adjuntar escuchadores de eventos a los botones de la herramienta de dibujo
                ...
                toolbar.querySelector('#clear-canvas-btn').onclick = () => {
                     ctx.clearRect(0, 0, canvas.width, canvas.height); // Borrar todo el lienzo
                     const activeNote = state.notes.find(n => n.id === currentNoteId);
                     if (activeNote) {
                         activeNote.content = null; // Borrar contenido de la nota
                         saveState();
                     }
                     drawingHistory = []; // Borrar historial
                     historyIndex = -1;
                     saveDrawingState(); // Guardar estado vacío en el historial
                };
                toolbar.querySelector('#undo-drawing-btn').onclick = undoDrawing;
                toolbar.querySelector('#redo-drawing-btn').onclick = redoDrawing;

                // Botón de pantalla completa para lienzo
            ...
            /**
             * Aplica un comando de formato de texto al editor de contenido editable.
             * @param {string} command - El comando document.execCommand (ej. 'bold', 'italic').
             * @param {string|null} [value=null] - El valor para el comando (ej. nombre de fuente).
             */
            function applyTextFormat(command, value = null) {
                document.execCommand(command, false, value);
                dom.noteContentEditor.focus(); // Mantener el foco en el editor
                updateToolbarButtonStates(); // Actualizar los estados activos de los botones de la barra de herramientas
                const note = state.notes.find(n => n.id === currentNoteId);
                if (note && note.type === 'text') {
                    note.content = dom.noteContentEditor.innerHTML; // Guardar contenido después de formatear
                    saveState();
                }
            }

            /**
             * Actualiza los estados activo/inactivo de los botones de la barra de herramientas de formato de texto
             * en función del formato de la selección actual.
             */
            ...
            /**
             * Maneja el evento de clic para las casillas de verificación de los elementos de la lista de verificación.
             * Actualiza el atributo `data-checked` y guarda el contenido de la nota.
             * @param {HTMLElement} target - El elemento en el que se hizo clic.
             */
            function handleChecklistItem(target) {
                if(!target.matches('.checklist-item-checkbox')) return;
                const isChecked = target.checked;
                const textSpan = target.nextElementSibling; // Obtener el span de texto hermano
                if (textSpan && textSpan.matches('.checklist-item-text')) {
                    textSpan.dataset.checked = isChecked; // Actualizar atributo de datos
                }
                const currentNote = state.notes.find(n => n.id === currentNoteId);
                if(currentNote) {
                    currentNote.content = dom.noteContentEditor.innerHTML; // Guardar contenido actualizado
                    saveState();
                }
            }

            /**
             * Inicia el proceso de compartir notas (actualmente una demostración).
             * Abre un modal para que el usuario introduzca un correo electrónico.
             */
            async function shareNote() {
                ...
                if (result.confirmed && result.data['share-email-input']) {
                    console.log(`(DEMO) Compartiendo nota ${currentNoteId} con ${result.data['share-email-input']}. Se necesita implementación backend.`);
            ...
            /**
             * Exporta la nota actual como un PDF.
             * Maneja tanto notas de texto (usando html2canvas) como notas de dibujo (desde la imagen del lienzo).
             */
            async function exportNoteAsPdf() {
                ...
                if (note.type === 'drawing') {
                    // Para notas de dibujo, exportar el lienzo directamente
                    const canvas = dom.noteCanvas;
                    ...
                    // Para notas de texto, usar html2canvas para renderizar el div contentEditable a una imagen, luego añadir al PDF
                    const content = dom.noteContentEditor; // Obtener el div contentEditable
                    const { jsPDF } = window.jspdf;
                    const pdf = new jsPDF();

                    html2canvas(content, {
                        scale: 2, // Aumentar la escala para una mejor resolución
                        useCORS: true // Requerido si el contenido incluye imágenes externas
                    }).then(canvas => {
                        const imgData = canvas.toDataURL('image/png');
            ...
            /**
             * Configura los escuchadores de eventos para cerrar un modal al hacer clic fuera de su contenido.
             * @param {HTMLElement} modalElement - El elemento contenedor principal del modal.
             * @param {Function} hideFunction - La función a llamar para ocultar el modal.
             */
            function setupModalClickOutside(modalElement, hideFunction) {
                if (!modalElement) return;
                modalElement.addEventListener('click', (e) => {
                    if (e.target === modalElement) { // Comprobar si el clic fue directamente en la superposición
                        hideFunction();
                    }
                });
            }
            ...
            /**
             * Alterna la visibilidad del contenedor del selector de voz.
             * (Actualmente, el selector de voz siempre está visible según el CSS).
            ...
            /**
             * Muestra el modal de motivación con una cita motivacional aleatoria.
             * También gestiona la alternancia de notificaciones de motivación.
             */
            function showMotivationModal() {
                ...
                // Mostrar cita aleatoria y texto del botón
                dom.motivationTitle.style.fontWeight = 'normal'; // Restablecer peso
                dom.motivationQuote.textContent = MOTIVATIONAL_MESSAGES[randomIndex];
                dom.motivationQuote.style.fontWeight = 'bold';
                dom.motivationQuote.classList.add('shimmer-text'); // Añadir efecto de brillo
                dom.closeMotivationModal.textContent = randomButtonText;

                setTimeout(() => dom.motivationQuote.classList.remove('shimmer-text'), 2500); // Eliminar brillo después de un retraso

                const toggle = dom.motivationToggle;
                toggle.checked = motivationEnabled; // Establecer el estado del interruptor según la preferencia
            }

            /**
             * Oculta el modal de motivación.
             */
            ...
            /**
             * Configura un intervalo periódico para las notificaciones de motivación si están habilitadas.
             */
            function setupMotivationInterval() {
                if (motivationInterval) clearInterval(motivationInterval); // Borrar cualquier intervalo existente
                if (!motivationEnabled) return; // Salir si las notificaciones de motivación están deshabilitadas

                const thirtyMinutes = 30 * 60 * 1000; // 30 minutos en milisegundos
                motivationInterval = setInterval(() => {
                    if (!motivationEnabled) { // Comprobar de nuevo dentro del intervalo en caso de que se haya deshabilitado
                    ...
                    showInAppNotification(title, body, 4000); // Mostrar notificación en la aplicación
                    triggerPushNotification(translations[lang].motivation_title, message); // Activar notificación push
            ...
            /**
             * Muestra la vista del traductor y configura su estado inicial.
             */
            function showTranslatorView() {
                dom.translatorView.style.display = 'flex';
                // Actualizar los títulos del chat para reflejar el flujo de trabajo del traductor
                ...
                updateContextualFooter('english-teacher-translate'); // Actualizar el mensaje del pie de página

                // Establecer el texto de marcador de posición predeterminado como se solicitó (en negrita)
                dom.translatorInputEs.value = '**Pega o escribe aquí lo que quieras y traduce correctamente al ingles:**\n\n';

                // Asegurarse de que la opción del modelo GOAT X esté disponible en el selector de modelo del traductor
                ...
                // Asegurarse de que la opción GOAT X PRO esté habilitada/deshabilitada según el plan del usuario
                const goatXProOption = dom.translatorModelSelector.querySelector('.goat-x-pro-model');
                if (goatXProOption) goatXProOption.disabled = !currentUser;
            }

            /**
             * Configura los escuchadores de eventos para la vista del traductor (botón de traducir, pegar, copiar).
             */
            function setupTranslatorEventListeners() {
                ...
                dom.translateBtn?.addEventListener('click', () => {
                    sendMessage(false, null, { assistantType: 'translator' }); // Enviar mensaje al traductor de IA
                });

                pasteBtn?.addEventListener('click', async () => {
                    try {
                        const text = await navigator.clipboard.readText(); // Leer del portapapeles
                        dom.translatorInputEs.value += text; // Añadir al input
                    } catch (err) {
                ...
                copyBtn?.addEventListener('click', () => {
                    dom.translatorOutputEn.select(); // Seleccionar texto en la salida
            ...
            /**
             * Configura todos los escuchadores de eventos globales para la aplicación.
             */
            function setupEventListeners() {
                // Escuchador de eventos para el botón de cerrar la notificación en la aplicación
                dom.inAppNotificationClose?.addEventListener('click', (e) => {
                    e.stopPropagation();
                    dom.inAppNotification.classList.remove('show');
                });
                // Escuchador de eventos para el botón de cerrar la notificación de tareas
                dom.taskNotificationCloseBtn?.addEventListener('click', hideTaskNotification);

                // Escuchador de eventos para hacer clic en la información de créditos del plan para mostrar detalles
                    ...
                    showModal({
                        ...
                        },
                        {
                            ...
                            action: () => {
                                ...
                                <li><strong>Traductor:</strong> ${COSTS.TRANSLATOR} crédito</li>
                                <li><strong>GOAT X (Chat General):</strong> ${COSTS.GENERAL} crédito</li>
                ...
                // Escuchador de eventos para hacer clic en los créditos de recompensa para mostrar el modal de gamificación
                ...
                // Escuchadores de eventos para el botón de motivación y el modal
                ...
                // Escuchador de eventos para el botón principal de enviar
                dom.sendBtn?.addEventListener('click', () => sendMessage(false, null, { assistantType: 'main' }));

                // Función auxiliar para configurar escuchadores de eventos para entradas de asistente
                ...
                // Configurar entradas de asistente para las vistas de proyecto, bloc de notas y traductor
                ...
                // Escuchador de eventos para la entrada principal de mensajes (textarea)
                ...
                // Escuchadores de eventos para crear nuevo chat y carpeta
                ...
                // Escuchadores de eventos para alternar precios y temas
                ...
                // Escuchadores de eventos para la edición del título del chat (escritorio y móvil)
                ...
                // Escuchadores de eventos para cargas de archivos y generación de imágenes
                ...
                if (SR && dom.micBtn) {
                    ...
                    recognition.onerror = (e) => { console.error("Error de reconocimiento de voz", e); isRecognizing = false; dom.micBtn.classList.remove('glowing-mic'); };
                    ...
                    dom.micBtn.addEventListener('click', () => {
                        ...
                        else { if (speechSynthesis.speaking) { speechSynthesis.cancel(); } try { recognition.start(); } catch(e) {console.error("No se pudo iniciar el reconocimiento", e)} }
                    });
                ...
                // Escuchador de cambio de selector de modelo
                ...
                // Borrar vistas previas de archivos
                ...
                dom.imageUploadInput?.addEventListener('change', (e) => {
                    if (e.target.files && e.target.files[0]) {
                        dom.filePreviewArea.style.display = "block"; // Mostrar área de vista previa de archivos
                        clearPdfData(); // Borrar PDF si se carga una imagen
                        const reader = new FileReader();
                        reader.onload = (ev) => {
                            selectedImageBase64 = ev.target.result;
                            dom.imagePreview.src = selectedImageBase64;
                            dom.imagePreviewContainer.classList.remove('hidden'); // Mostrar contenedor de vista previa de imagen
                            dom.imageName.textContent = e.target.files[0].name; // Mostrar nombre de imagen
                        };
                        reader.readAsDataURL(e.target.files[0]);
                    }
                });

                // Manejador de carga de PDF
                dom.pdfUploadInput?.addEventListener('change', (e) => {
                    const file = e.target.files[0];
                    if (!file || file.type !== 'application/pdf') return;
                    dom.filePreviewArea.style.display = "block"; // Mostrar área de vista previa de archivos
                    clearImageData(); // Borrar imagen si se carga un PDF
                    ...
                    dom.pdfPreviewContainer.classList.remove('hidden'); // Mostrar contenedor de vista previa de PDF
                    const reader = new FileReader();
                    reader.onload = async (ev) => {
                        ...
                        try {
                            ...
                            setTimeout(clearPdfData, 2000); // Borrar datos del PDF después del error
                        }
                    };
                    reader.readAsArrayBuffer(file);
                });

                // Funcionalidad de alternancia de la barra lateral
                ...
                // Configuración de botones de flujo de trabajo
                ...
                // Escuchador de eventos para alternar categorías de flujo de trabajo y botones de flujo de trabajo
                document.body.addEventListener('click', e => {
                    ...
                    if (header) {
                        ...
                        if (category && (category.classList.contains('workflow-category') || category.classList.contains('actions-category') || category.classList.contains('folders-category'))) {
                            // Solo alternar si el clic no es en un botón de acción hijo (como renombrar/eliminar)
                            if (!e.target.closest('.chat-item-actions') && !e.target.closest('#add-project-folder-btn')) {
                                ...
                                // Para carpetas de proyectos, persistir su estado abierto/cerrado
                        ...
                        const config = workflowConfigs[workflowKey];
                         if (config) {
                            if (workflowKey === 'notepad-app') {
                                selectChat('notepad-app'); // Manejo especial para la aplicación de bloc de notas
                            } else if (workflowKey === 'english-teacher-translate') {
                                selectChat('translator-view'); // Manejo especial para la vista del traductor
                            }
                            else {
                                createNewChat(config); // Crear un nuevo chat para otros flujos de trabajo
                            }
                        }
                    }
                });
                ...
                document.addEventListener('click', (e) => {
                    // Cerrar el menú emergente de usuario si se hace clic fuera
                    ...
                    // Cerrar el menú desplegable de filtro de etiquetas si se hace clic fuera
                    if (dom.tagFilterDropdown && dom.tagFilterBtn && !dom.tagFilterBtn.contains(e.target) && !dom.tagFilterDropdown.contains(e.target)) {
                     ...
                     if (dom.calendarTagFilterDropdown && dom.calendarTagFilterBtn && !dom.calendarTagFilterBtn.contains(e.target) && !dom.calendarTagFilterDropdown.contains(e.target)) {
                        dom.calendarTagFilterDropdown.classList.add('hidden');
                    }
                    // Cerrar los menús desplegables "añadir a carpeta" si se hace clic fuera
                ...
                // Enlaces de solución de WhatsApp
                const solutionLinks = {
                ...
                dom.deleteSelectedBtn?.addEventListener('click', async () => {
                    ...
                    if (confirm.confirmed) {
                        chatsToDelete.forEach(id => deleteItem(id.split('-')[0], id)); // Eliminar cada elemento seleccionado
                        toggleSelectMode(false); // Salir del modo de selección
                    }
                });

                // Botones y controles del modal de configuración
                ...
                dom.fontSizeSlider?.addEventListener('input', (e) => {
                    ...
                    document.body.style.setProperty('--base-font-size', `${fontSize}px`); // Actualizar la variable CSS para el tamaño de fuente
                ...
                dom.notificationsToggle?.addEventListener('change', async () => {
                    ...
                    if (notificationsEnabled) {
                        const permission = await Notification.requestPermission(); // Solicitar permiso de notificación
                        if (permission === 'granted') {
                            registerServiceWorkerAndSubscribe(); // Registrar SW y suscribirse para push
                        } else {
                            // Si el permiso es denegado, revertir el interruptor y deshabilitar las notificaciones
                            notificationsEnabled = false;
                ...
                dom.connectWhatsappBtn?.addEventListener('click', () => {
                    window.open('[https://wa.me/17439106116?text=Hola%2C%20me%20gustar%C3%ADa%20conectar%20mi%20cuenta%20de%20Goatify%20IA%20a%20WhatsApp](https://wa.me/17439106116?text=Hola%2C%20me%20gustar%C3%ADa%20conectar%20mi%20cuenta%20de%20Goatify%20IA%20a%20WhatsApp).', '_blank');
                });
                dom.scheduleMeetingBtn?.addEventListener('click', () => {
                    window.open('[https://calendly.com/goatify](https://calendly.com/goatify)', '_blank');
                });
                dom.freePlanButton?.addEventListener('click', showPricingModal);

                // Botones y controles del modal del calendario
                ...
                dom.viewToggleList.addEventListener('click', () => {
                 ...
                 dom.addTaskListViewBtn.addEventListener('click', () => {
                    if (currentChatId) {
                        editProjectTask(currentChatId, null, 'todo'); // Añadir tarea a la columna 'todo'
                    }
                });

                // Alternadores de colapso de chat para asistentes de proyecto, financiero, bloc de notas
                document.body.addEventListener('click', e => {
                ...
                // Escuchadores de eventos del BLOC DE NOTAS
                ...
                dom.exportPdfBtn?.addEventListener('click', exportNoteAsPdf); // Nuevo: Botón Exportar a PDF
                dom.noteBackBtn?.addEventListener('click', () => {
                    dom.notepadViewContainer.classList.remove('mobile-editor-active'); // Volver a la lista de notas en móvil
                });
                dom.noteTitleInput?.addEventListener('input', (e) => {
                    ...
                    if (note && note.title !== e.target.value) {
                        ...
                        saveState();
                        renderSidebar(); // Actualizar la barra lateral con el nuevo título
                    }
                });
                dom.noteContentEditor?.addEventListener('input', () => {
                    const note = state.notes.find(n => n.id === currentNoteId);
                     if (note && note.type === 'text') {
                        note.content = dom.noteContentEditor.innerHTML; // Guardar contenido del editor
                        saveState();
                    }
                });
                dom.noteContentEditor?.addEventListener('keydown', (e) => {
                    // Manejar la tecla Enter para elementos de la lista de verificación
                    if (e.key === 'Enter' && !e.shiftKey) {
                ...
                // Botones de formato del editor de texto
                ...
                dom.justifyBtn?.addEventListener('click', () => applyTextFormat('justifyFull')); // Botón Justificar añadido

                dom.fontFamilySelector?.addEventListener('change', (e) => {
                    const selectedFont = e.target.value;
                    dom.noteContentEditor.style.fontFamily = selectedFont; // Aplicar familia de fuentes
                    localStorage.setItem('notepad-font-family', selectedFont); // Guardar preferencia
                    const note = state.notes.find(n => n.id === currentNoteId);
                    if (note && note.type === 'text') {
                ...
                dom.noteContentEditor?.addEventListener('mouseup', updateToolbarButtonStates); // Actualizar estados de botones al cambiar la selección
                dom.noteContentEditor?.addEventListener('keyup', updateToolbarButtonStates); // Actualizar estados de botones al soltar la tecla
                dom.noteContentEditor?.addEventListener('click', e => {
                    handleChecklistItem(e.target); // Manejar clics en elementos de la lista de verificación
                ...
                dom.addChecklistItemBtn?.addEventListener('click', () => {
                    ...
                    if (!currentContainer) {
                        // Si no hay un contenedor específico, añadir al editor
                        ...
                        if (newTextSpan) {
                            newTextSpan.focus(); // Enfocar en el nuevo elemento de la lista de verificación
                        }
                    } else {
                        // Si está dentro de un texto existente o un elemento de la lista de verificación, insertar un nuevo elemento de la lista de verificación
                ...
                // Escuchadores de eventos para alternar los detalles del plan de precios
                ...
                // Configurar escuchadores de clic fuera para modales
                ...
                setupModalClickOutside(dom.creditLimitModal, () => { // Modificado para manejar el botón "Ver Planes"
                    hideModal();
                    showPricingModal();
                });

                // Escuchadores de modales de gamificación
                ...
                // Modal de reglas de gamificación
                ...
                // Botones de misión de gamificación
                dom.missionsContainer.addEventListener('click', (e) => {
                    ...
                    if (button && !button.disabled) {
                        ...
                        if (mission && mission.workflow) {
                            ...
                            if(workflowButton) {
                                workflowButton.click(); // Simular clic en el botón del flujo de trabajo
                                dom.closeGamificationModal.click(); // Cerrar el modal de gamificación
                            }
                        } else if (mission && mission.action === 'generateImage') {
                            generateImage(); // Activar la generación de imágenes
                            dom.closeGamificationModal.click();
                        } else {
                            dom.closeGamificationModal.click();
                        }
            ...
            /**
             * Renderiza la vista de gestión de proyectos para un chat de proyecto específico.
             * Inicializa los datos del proyecto si no están presentes y renderiza el tablero del proyecto.
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderProjectView(chatId) {
                const chat = state.chats[chatId];
                if (!chat) return;

                // Recrear la estructura del chat del proyecto para asegurar que no esté en blanco
                // y que los listeners se puedan volver a adjuntar correctamente.
                const projectChatContainer = document.getElementById('project-chat-container');
                if (projectChatContainer) {
                    projectChatContainer.innerHTML = `
                        <div id="project-chat-container-header" class="flex justify-between items-center cursor-pointer p-2">
                            <h3 class="text-lg font-semibold text-primary" data-translate-key="project_assistant">Asistente del Proyecto</h3>
                            <button id="project-chat-toggle" class="text-xl p-2"><i class="fas fa-angle-up"></i></button>
                        </div>
                         <div class="project-chat-body">
                            <div id="project-chat-messages" class="flex-grow overflow-y-auto p-2"></div>
                            <div id="project-input-area" class="mt-auto pt-2">
                                 <div class="pro-controls-bg rounded-lg p-1.5 mb-2">
                                     <div class="flex items-center space-x-2">
                                        <label for="project-model-selector" class="font-medium text-xs text-text-medium pl-2 pr-1" data-translate-key="model">Modelo:</label>
                ...
                if (!chat.projectData) {
                    // Inicializar datos de proyecto predeterminados si no están presentes
                    chat.projectData = {
                        title: chat.title,
                        columns: [
                             { id: 'todo', title: 'Por Hacer', tasks: [] },
                ...
                dom.projectViewTitle.textContent = chat.projectData.title; // Establecer título del proyecto
                
                // Volver a asignar los elementos DOM del chat del proyecto después de recrearlos
                ...
                if(projectChatMessages) {
                    ...
                    // Mostrar mensajes de chat del proyecto
                    (chat.messages || []).forEach((msg, index) => addMessageToUI(msg.role, msg.content, msg.image, index, projectChatMessages));
                }

                // Colapsar el chat del proyecto en móvil por defecto
                if (window.innerWidth < 768) {
                    projectChatContainer.classList.add('collapsed');
                } else {
                    projectChatContainer.classList.remove('collapsed');
                }
                renderProjectBoard(chatId); // Renderizar el tablero Kanban o Lista

                // Volver a adjuntar los listeners para los elementos del chat recién creados
                attachProjectChatListeners(chatId);
            }

            /**
             * Adjunta los escuchadores de eventos para el área de chat del asistente de proyectos.
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function attachProjectChatListeners(chatId) {
                const projectModelSelector = document.getElementById('project-model-selector');
                const sendBtn = document.getElementById('project-send');
                const msgInput = document.getElementById('project-msg');

                if (projectModelSelector) {
                    const goatXProOption = projectModelSelector.querySelector('.goat-x-pro-model');
                    if (goatXProOption) goatXProOption.disabled = !currentUser;
                }
                if(sendBtn) sendBtn.addEventListener('click', () => sendMessage(false, null, { assistantType: 'project' }));
                if(msgInput) msgInput.addEventListener('keydown', e => {
                    if (e.key === 'Enter' && !e.shiftKey) {
                        e.preventDefault();
                        sendMessage(false, null, { assistantType: 'project' });
                    }
                });
            }

            /**
             * Renderiza el tablero del proyecto (vista Kanban o Lista) para un chat de proyecto determinado.
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderProjectBoard(chatId) {
                ...
                // Alternar la visibilidad de las vistas Kanban, Lista de escritorio y Lista de móvil
                ...
                dom.addTaskListViewBtn.style.display = isKanban ? 'none' : 'block'; // Mostrar/ocultar el botón de añadir tarea
                ...
                renderTagFilter(chatId); // Renderizar filtro de etiquetas
            }

            /**
             * Renderiza la vista del tablero Kanban para un proyecto.
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderKanbanView(chatId) {
                const { projectData } = state.chats[chatId];
                dom.kanbanView.innerHTML = ''; // Limpiar el contenido Kanban existente
                ...
                projectData.columns.forEach(column => {
                    ...
                    // Filtrar tareas por etiqueta activa
                    ...
                    tasksToRender.forEach(task => {
                        ...
                        cardEl.dataset.taskId = task.id; // Almacenar ID de tarea
                        ...
                        cardEl.addEventListener('touchstart', handleTouchStart, {passive: false}); // Arrastre táctil para móvil
                        ...
                        cardEl.addEventListener('click', (e) => {
                            if (e.target.classList.contains('delete-task-icon')) {
                                ...
                                editProjectTask(chatId, task.id); // Editar tarea al hacer clic
                            }
                        });
                    ...
                    // Escuchadores de arrastrar y soltar para las columnas Kanban
                    ...
                    cardsContainer.addEventListener('drop', e => {
                        ...
                        const taskId = e.dataTransfer.getData('text/plain');
                        if (!taskId.startsWith('proj-')) return; // Solo aceptar tareas de proyecto
                         moveTask(chatId, taskId, column.id); // Mover tarea a esta columna
                    });
                    dom.kanbanView.appendChild(columnEl);
                });

                // Botón de añadir tarea para cada columna
                dom.kanbanView.querySelectorAll('.add-task-to-column-btn').forEach(btn => {
                    btn.addEventListener('click', (e) => {
                        const columnId = e.currentTarget.dataset.columnId;
                        editProjectTask(chatId, null, columnId); // Añadir nueva tarea a una columna específica
                    });
                });
            }

            /**
             * Renderiza la vista de Lista para un proyecto (versión de escritorio).
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderListView(chatId) {
                const { projectData } = state.chats[chatId];
                dom.listView.innerHTML = ''; // Limpiar el contenido de la lista existente
                ...
                projectData.columns.forEach(column => {
                    ...
                    // Escuchadores de arrastrar y soltar para los títulos de las columnas (para soltar tareas en las columnas)
                    ...
                    tasksToRender.forEach(task => {
                        ...
                        if(column.id !== 'done') taskEl.draggable = true; // No permitir arrastrar desde la columna 'done'
                        taskEl.dataset.taskId = task.id;
                        ...
                        taskEl.addEventListener('touchstart', handleTouchStart, {passive: false}); // Arrastre táctil para móvil
                    ...
                    newRowEl.querySelector('.add-task-to-list-btn').addEventListener('click', () => {
                        editProjectTask(chatId, null, column.id); // Añadir nueva tarea a una columna específica
                    });
                ...
                // Escuchadores de eventos para edición en línea y acciones
                dom.listView.querySelectorAll('.task-content-list input').forEach(input => {
                    ...
                    input.addEventListener('blur', save); // Guardar al perder el foco
                    input.addEventListener('keydown', (e) => { if (e.key === 'Enter') input.blur(); }); // Guardar al presionar Enter
                });
                ...
                dom.listView.querySelectorAll('.priority-cell').forEach(cell => {
                     cell.addEventListener('click', (e) => {
                        ...
                        if(task) updateTaskStatus(taskId, { urgent: !task.urgent }); // Alternar estado urgente
                    });
                });
            ...
            /**
             * Renderiza la vista de Lista para un proyecto (versión móvil).
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderListViewMobile(chatId) {
                const { projectData } = state.chats[chatId];
                dom.listViewMobile.innerHTML = ''; // Limpiar el contenido de la lista móvil existente

                projectData.columns.forEach(column => {
                    const columnEl = document.createElement('div');
                    columnEl.className = "list-view-column-mobile my-2";
                    columnEl.dataset.columnId = column.id; // Almacenar ID de columna para soltar
                    const columnTitle = document.createElement('h4');
                    ...
                    // Escuchadores de arrastrar y soltar para columnas de lista móvil
                ...
                // Escuchadores de eventos para edición en línea y acciones en la vista de lista móvil
            ...
            /**
             * Elimina una tarea del calendario personal o de un proyecto.
             * Confirma la eliminación con el usuario.
             * @param {string} taskId - El ID de la tarea a eliminar.
             * @param {string} [chatId] - El ID del chat del proyecto (si es una tarea del proyecto).
             */
            async function deleteTask(taskId, chatId) {
                ...
                if (result.confirmed) {
                    ...
                    if (found.type === 'personal') {
                        ...
                        state.calendar[dayKey].splice(taskIndex, 1); // Eliminar del calendario personal
                        if(state.calendar[dayKey].length === 0) delete state.calendar[dayKey]; // Eliminar entrada del día si está vacía
                    } else if (found.type === 'project') {
                        const { column, taskIndex } = found;
                        column.tasks.splice(taskIndex, 1); // Eliminar de la columna del proyecto
                    }
                    saveState(); // Guardar el estado actualizado
                    if (dom.calendarModalOverlay.classList.contains('flex')) renderCalendarView(); // Volver a renderizar el calendario si está abierto
                    if (dom.projectManagementView.style.display === 'flex') renderProjectBoard(chatId || currentChatId); // Volver a renderizar el tablero del proyecto si está abierto
                }
            }

            /**
             * Edita una tarea de proyecto existente o añade una nueva.
             * Abre un modal para los detalles de la tarea.
             * @param {string} chatId - El ID del chat del proyecto.
             * @param {string|null} taskId - El ID de la tarea a editar, o null para una nueva tarea.
             * @param {string} [columnIdForNew] - El ID de la columna a la que añadir una nueva tarea.
             */
                    ...
                    if (newContent.trim()) {
                        ...
                        if (isNew) {
                            ...
                            if (column) {
                                ...
                                completeMission('project-created', chatId); // Completar misión para nueva tarea de proyecto
                            }
                        } else {
                            updateTaskStatus(taskId, updatedTaskData); // Actualizar tarea existente
                        }
                    }
                }
            }
            ...
            /**
             * Edita una tarea de calendario personal existente o añade una nueva.
             * Incluye una opción para crear un nuevo proyecto a partir de una tarea.
             * @param {string|null} taskId - El ID de la tarea a editar, o null para una nueva tarea.
             * @param {string} [preselectedDate=null] - Fecha preseleccionada para una nueva tarea.
             * @param {string} [preselectedTime=null] - Hora preseleccionada para una nueva tarea.
             */
            async function editCalendarTask(taskId, preselectedDate = null, preselectedTime = null) {
                ...
                const createProjectFromTask = async (modalBody) => {
                    ...
                    }, 250); // Pequeño retraso para permitir que el modal se cierre
                };
                ...
                if (result.confirmed) {
                    ...
                    if (newContent.trim() && newDate) {
                        if(isNew && result.data['create-project-checkbox']) {
                             // Si se crea un nuevo proyecto, pasar los datos del modal actual a la función de creación del proyecto
                        ...
                        saveState();
                        renderCalendarView();
                        completeMission('week-organized'); // Completar misión por organizar la semana
                    }
                }
            }

            /**
             * Mueve una tarea de proyecto a una columna diferente dentro del mismo proyecto.
             * @param {string} chatId - El ID del chat del proyecto.
             * @param {string} taskId - El ID de la tarea a mover.
             * @param {string} targetColumnId - El ID de la columna de destino.
             */
            function moveTask(chatId, taskId, targetColumnId) {
                const found = findTask(taskId);
                // Asegurarse de que sea una tarea de proyecto y que no se esté moviendo a su columna actual
                if (!found || found.type !== 'project' || found.column.id === targetColumnId) return;

                const [taskToMove] = found.column.tasks.splice(found.taskIndex, 1); // Eliminar la tarea de la columna actual
                taskToMove.completed = targetColumnId === 'done'; // Establecer el estado de finalización si se mueve a 'done'
                ...
                if (targetColumn) {
                    ...
                    targetColumn.tasks.push(taskToMove); // Añadir tarea a la columna de destino
                }

                saveState(); // Guardar el estado actualizado
                renderProjectBoard(chatId); // Volver a renderizar el tablero del proyecto
            }

            /**
             * Genera un color consistente para una cadena de etiqueta dada.
             * @param {string} label - La cadena de etiqueta.
             * @returns {string} Una cadena de color hexadecimal.
             */
            function getLabelColor(label) {
                if (!label) return 'var(--text-medium)';
                if (label === 'Personal') return 'var(--primary)'; // Color específico para la etiqueta 'Personal'
                ...
                let color = '#';
                for (let i = 0; i < 3; i++) {
                    let value = (hash >> (i * 8)) & 0xCF; // Usar 0xCF para asegurar colores más claros
            ...
            /**
             * Renderiza el menú desplegable de filtro de etiquetas para tareas de proyecto.
             * @param {string} chatId - El ID del chat del proyecto.
             */
            function renderTagFilter(chatId) {
                const { projectData } = state.chats[chatId];
                const allTasks = projectData.columns.flatMap(c => c.tasks || []);
                const allTags = [...new Set(allTasks.flatMap(t => t.labels || []))]; // Obtener etiquetas únicas

                dom.tagFilterDropdown.innerHTML = ''; // Limpiar opciones de filtro existentes
                ...
                allBtn.onclick = () => {
                    activeTagFilter = null; // Borrar filtro
                    dom.tagFilterBtn.innerHTML = `<i class="fas fa-tag mr-1"></i> Filtrar`;
                    dom.tagFilterDropdown.classList.add('hidden');
                    renderProjectBoard(chatId); // Volver a renderizar el tablero sin filtro
                };
                ...
                allTags.forEach(tag => {
                    ...
                    btn.innerHTML = `<span class="task-label inline-block mr-2" style="background-color: ${getLabelColor(tag)}; color: white;">${tag}</span>`;
                     btn.onclick = () => {
                        activeTagFilter = tag; // Establecer filtro activo
                        ...
                        dom.tagFilterDropdown.classList.add('hidden');
                         renderProjectBoard(chatId); // Volver a renderizar el tablero con filtro
                    };
                    dom.tagFilterDropdown.appendChild(btn);
                });
                dom.tagFilterBtn.onclick = () => {
                    dom.tagFilterDropdown.classList.toggle('hidden'); // Alternar la visibilidad del menú desplegable
                };
            }

            /**
             * Renderiza el filtro de etiquetas para el modal del calendario.
             */
            function renderCalendarTagFilter() {
                const allProjectTasks = Object.values(state.chats)
                    .filter(c => c.projectData)
                    .flatMap(c => c.projectData.columns)
                    .flatMap(col => col.tasks || []);
                
                const allTags = [...new Set(allProjectTasks.flatMap(t => t.labels || []))];
                allTags.unshift('Personal'); // Añadir 'Personal' como una etiqueta filtrable

                dom.calendarTagFilterDropdown.innerHTML = '';
                ...
                allBtn.onclick = () => {
                    ...
                    dom.calendarTagFilterBtn.innerHTML = `<i class="fas fa-tag mr-1"></i> Filtrar`;
                    dom.calendarTagFilterDropdown.classList.add('hidden');
                    renderCalendarView();
                };
                dom.calendarTagFilterDropdown.appendChild(allBtn);
                ...
                allTags.forEach(tag => {
                    ...
                    btn.onclick = () => {
                        activeTagFilter = tag;
                        dom.calendarTagFilterBtn.innerHTML = `<span class="task-label inline-block mr-2" style="background-color: ${getLabelColor(tag)}; color: white;">${tag}</span>`;
                        dom.calendarTagFilterDropdown.classList.add('hidden');
                        renderCalendarView();
                    };
                    dom.calendarTagFilterDropdown.appendChild(btn);
                });

                dom.calendarTagFilterBtn.onclick = () => {
                    dom.calendarTagFilterDropdown.classList.toggle('hidden');
                };
            }

            /**
             * Renderiza la vista del Asistente Financiero para un chat financiero específico.
             * @param {string} chatId - El ID del chat financiero.
             */
            function renderFinancialAssistant(chatId) {
                const chat = state.chats[chatId];
                if (!chat) return;

                // Construir la estructura HTML para el asistente financiero
                ...
                renderFinancialData(chatId); // Renderizar datos financieros reales
                attachFinancialListeners(chatId); // Adjuntar escuchadores de eventos para el asistente financiero
                if (window.innerWidth < 768) {
                    document.getElementById('financial-chat-container').classList.add('collapsed'); // Colapsar chat en móvil
                }

                // Deshabilitar la opción GOAT X PRO para usuarios no registrados en el selector de modelo financiero
            ...
            /**
             * Renderiza las categorías de ingresos y gastos financieros y sus elementos.
            ...
            function renderFinancialData(chatId) {
                ...
                // Ayudante para renderizar una sola categoría financiera
                const renderCategory = (category, type) => {
                    ...
                    categoryEl.innerHTML = `
                        <div class="finance-category-header">
                            ...
                            <div>
                                <button class="add-finance-item-btn text-primary p-1 mr-2" title="Añadir Item"><i class="fas fa-folder-plus mr-1"></i></button>
                ...
                recalculateFinances(chatId); // Recalcular y mostrar totales
            }
            /**
             * Adjunta escuchadores de eventos para la interfaz de usuario del Asistente Financiero.
             * Maneja la adición/eliminación de categorías y elementos, y la actualización de valores.
             * @param {string} chatId - El ID del chat financiero.
             */
            function attachFinancialListeners(chatId) {
                ...
                // Configurar botón de enviar y tecla Enter para el chat financiero
                ...
                // Escuchador de eventos para cambios en la entrada (nombres de categorías, descripciones/cantidades de elementos)
                view.addEventListener('input', (e) => {
                    if (e.target.classList.contains('finance-category-name-input')) {
                        ...
                        if (item) {
                           ...
                           recalculateFinances(chatId); // Recalcular totales al cambiar la cantidad del elemento
                           saveState();
                        }
                    }
                });

                // Escuchador de eventos para acciones de clic (añadir/eliminar elementos/categorías)
                view.addEventListener('click', async (e) => {
                    ...
                    if(addItemBtn) {
                        ...
                        if (category) {
                            ...
                            renderFinancialData(chatId); // Volver a renderizar para mostrar el nuevo elemento
                            saveState();
                        }
                        return;
                    }
                    ...
                    if (deleteItemBtn) {
                        ...
                        if (category) {
                            ...
                            renderFinancialData(chatId); // Volver a renderizar después de la eliminación
                            saveState();
                        }
                        return;
                    }
                ...
                // Renderizar mensajes de chat financiero
            ...
            /**
             * Recalcula y muestra el total de ingresos, el total de gastos y el saldo neto.
             * @param {string} chatId - El ID del chat financiero.
             */
            function recalculateFinances(chatId) {
                ...
                // Ayudante para sumar las cantidades de todos los elementos dentro de las categorías
                ...
                netBalanceEl.style.color = netBalance >= 0 ? '#22c55e' : '#ef4444'; // Color según el saldo positivo/negativo
            }

            /**
             * Comprueba si la misión "semana organizada" está completada.
             * Requiere al menos una tarea para cada día de la semana actual.
             * @returns {boolean} Verdadero si la misión está completada, falso en caso contrario.
             */
            function checkWeekOrganized() {
                const startOfWeek = dayjs().startOf('isoWeek');
                for (let i = 0; i < 7; i++) {
                    const dayKey = startOfWeek.add(i, 'day').format('YYYY-MM-DD');
                    if (getTasksForDay(dayKey).length === 0) return false; // Si algún día no tiene tareas, la misión no está completa
                }
                return true;
            }
            /**
             * Comprueba si la misión "proyecto creado" está completada.
             * Requiere un número específico de tareas en un proyecto dado.
             * @param {string} chatId - El ID del chat del proyecto.
             * @param {number} taskCount - El número mínimo de tareas requeridas.
             * @returns {boolean} Verdadero si la misión está completada, falso en caso contrario.
             */
            ...
            /**
             * Devuelve el estado de gamificación predeterminado.
             * @returns {object} El objeto de estado de gamificación predeterminado.
             */
            ...
            /**
             * Carga el estado de gamificación desde el almacenamiento local.
             * Inicializa con el estado predeterminado si no se encuentra.
             * Comprueba y actualiza la racha diaria.
             */
            async function loadGamificationState() {
                if(!currentUser) {
                    gamificationState = getDefaultGamificationState(); // Restablecer para invitados
                    return;
                }
                ...
                // Cargar créditos de recompensa del almacenamiento local si existen (manejo heredado)
                ...
                await checkDailyStreak(); // Comprobar la racha diaria al cargar
            }

            /**
             * Guarda el estado actual de gamificación en el almacenamiento local.
             */
            function saveGamificationState() {
                if(!currentUser) return;
                const key = `gamificationState_${currentUser.id}`;
                localStorage.setItem(key, JSON.stringify(gamificationState));
                // Persistir créditos de recompensa por separado también (para compatibilidad con versiones anteriores/simplicidad)
                localStorage.setItem(`reward_credits_${currentUser.id}`, gamificationState.credits);
                renderGamificationModal(); // Volver a renderizar el modal de gamificación
                updateCreditCounter(); // Actualizar la visualización de créditos
            }

            /**
             * Añade puntos de experiencia (XP) al estado de gamificación del usuario.
             * Maneja la lógica de subida de nivel.
            ...
            function addXp(amount) {
                ...
                if (currentLevel >= LEVEL_NAMES.length) return; // Ya en el nivel máximo

                const nextLevelXp = XP_FOR_LEVEL[currentLevel];
                if (gamificationState.xp >= nextLevelXp) {
                    gamificationState.level++; // Incrementar nivel
                ...
                saveGamificationState(); // Guardar el estado actualizado
            }

            /**
             * Añade créditos de recompensa al estado de gamificación del usuario.
             ...
             * Otorga XP y créditos en función de la duración de la racha.
             * Activa la apertura del Cofre GOAT el día 7.
             */
            async function checkDailyStreak() {
                ...
                if (lastLogin === today) {
                    console.log("Racha ya procesada para hoy.");
                    return; // Ya procesado para hoy
                }

                const yesterday = dayjs().subtract(1, 'day').format('YYYY-MM-DD');
                if (lastLogin === yesterday) {
                    gamificationState.dailyStreak++; // Incrementar racha si inició sesión ayer
                } else {
                    if (lastLogin !== null) {
                        console.log("Racha diaria restablecida.");
                    }
                    gamificationState.dailyStreak = 1; // Restablecer racha si no es consecutiva
                }

                gamificationState.lastLogin = today; // Actualizar la fecha del último inicio de sesión
                const streak = gamificationState.dailyStreak;
                let xpReward = 10, creditReward = 5;
                if (streak > 3 && streak <=6) { xpReward = 20; creditReward = 10; } // Recompensas aumentadas para rachas más largas

                if (streak % 7 === 0 && streak > 0) {
                    addXp(100); // XP de bonificación por racha de 7 días
                    openGoatChest(); // Abrir cofre especial
                } else {
                    addXp(xpReward);
                ...
                if (gamificationState.dailyStreak >= 30) {
                    unlockAchievement('streak-30'); // Desbloquear logro por racha de 30 días
                }
            ...
            /**
             * Abre el "Cofre GOAT" especial otorgado en cada racha de 7 días.
             * Otorga recompensas aleatorias como créditos, descuentos o consulta gratuita.
             */
            function openGoatChest() {
                const rand = Math.random();
                let rewardTitle, rewardBody;

                if (rand < 0.01) { // 1% de probabilidad de recompensa legendaria
                ...
                } else if (rand < 0.1) { // 9% de probabilidad de recompensa épica
            ...
            /**
             * Completa una misión de gamificación especificada si se cumplen sus condiciones.
             * Otorga XP y créditos por la finalización.
             * @param {string} missionId - El ID de la misión a completar.
             * @param {string|null} [contextId=null] - ID de contexto opcional (ej. ID de chat para misión de proyecto).
             */
            function completeMission(missionId, contextId = null) {
                if (!currentUser || gamificationState.completedMissions.includes(missionId)) return; // Ya completado o sin usuario
                const mission = MISSIONS[missionId];
                if (!mission) return;

                let isCompleted = false;
                if (mission.condition) {
                    isCompleted = mission.condition(contextId); // Comprobar condición personalizada
                } else {
                     isCompleted = true; // Sin condición específica, autocompletar
                }

                if (isCompleted) {
                    gamificationState.completedMissions.push(missionId); // Marcar como completado
                    addXp(mission.xp); // Añadir XP
                    addCredits(mission.credits); // Añadir créditos
                    showModal({
            ...
            /**
             * Desbloquea un logro de gamificación especificado si se cumplen sus condiciones.
             * Otorga XP y posibles recompensas especiales.
             * @param {string} achievementId - El ID del logro a desbloquear.
             */
            function unlockAchievement(achievementId) {
                if (!currentUser || gamificationState.unlockedAchievements.includes(achievementId)) return; // Ya desbloqueado o sin usuario
                const achievement = ACHIEVEMENTS[achievementId];
                if (!achievement) return;

                gamificationState.unlockedAchievements.push(achievementId); // Marcar como desbloqueado
                addXp(achievement.xp); // Añadir XP
                if (achievement.credits) addCredits(achievement.credits); // Añadir créditos si se especifica
                showModal({
            ...
            /**
             * Renderiza el modal de gamificación con el nivel actual, XP, racha, misiones y logros.
             */
            function renderGamificationModal() {
                ...
                if (level < LEVEL_NAMES.length) {
                    ...
                    dom.gamificationXpBar.style.width = `${Math.min(100, progress)}%`; // Actualizar la anchura de la barra de XP
                } else {
                    dom.gamificationXp.textContent = '¡Nivel Máximo!'; // Nivel máximo alcanzado
                    dom.gamificationXpBar.style.width = `100%`;
                }

                // Renderizar la visualización de la racha diaria
                dom.dailyStreakContainer.innerHTML = '';
                for (let i = 1; i <= 7; i++) {
                    const dayEl = document.createElement('div');
                    dayEl.className = 'streak-day p-4 rounded-lg flex flex-col items-center justify-center';
                    const isCompleted = i <= gamificationState.dailyStreak; // Comprobar si el día de la racha está completado
                    const isActive = i === gamificationState.dailyStreak + 1 && dayjs().format('YYYY-MM-DD') !== gamificationState.lastLogin; // Comprobar si el día siguiente está activo

                    if (isCompleted) dayEl.classList.add('completed');
                    if (isActive) dayEl.classList.add('active');

                    let rewardText;
                    if (i === 7) rewardText = '<i class="fas fa-gift fa-2x"></i>'; // Icono especial para el día 7
                ...
                // Renderizar la visualización de misiones
                ...
                // Renderizar la visualización de logros
            ...
            let initFired = false; // Bandera para asegurar que la inicialización solo se ejecute una vez
            /**
             * Completa el proceso de inicialización de la aplicación.
             * Carga el estado del usuario, actualiza la interfaz de usuario, configura los servicios y maneja las notificaciones iniciales.
             * @param {object|null} user - El objeto de usuario de Netlify Identity, o null si no ha iniciado sesión.
             */
            const finishInitialization = async (user) => {
                // Evitar la reinicialización si ya se activó para el mismo usuario
                if (initFired && user?.id === currentUser?.id) return;
                initFired = true;
                if (user && !currentUserToken) { try { currentUserToken = await user.jwt(); } catch(e) { console.error(e); } }
                const wasGuest = !currentUser; // Comprobar si el usuario era previamente un invitado
                currentUser = user; // Establecer el usuario actual

                try {
                    await loadStateForUser(); // Cargar el estado de la aplicación (chats, notas, proyectos, calendario)
                    updateUserUI(); // Actualizar elementos de la interfaz de usuario según el estado de inicio de sesión del usuario
                    populateVoiceList(); // Rellenar voces de texto a voz
                    setupEventListeners(); // Adjuntar todos los escuchadores de eventos globales

                    // Registrar Service Worker y suscribirse a las notificaciones push si las notificaciones están habilitadas y el usuario ha iniciado sesión
                    if (currentUser && notificationsEnabled) {
                         registerServiceWorkerAndSubscribe();
                    }
                    updateContextualFooter(state.chats[currentChatId]?.workflow); // Actualizar el mensaje inicial del pie de página contextual
                    setupMotivationInterval(); // Iniciar notificaciones de motivación periódicas

                     if (loadingInterval) {
                        clearInterval(loadingInterval);
                    }
                    
                    dom.appContainer.classList.remove('opacity-0'); // Mostrar el contenedor principal de la aplicación
                    dom.loadingOverlay.style.display = 'none'; // Ocultar la superposición de carga

                    updateNotificationBadge(); // Actualizar la insignia de notificación de tareas

                    // Mostrar modal de motivación para nuevos usuarios que han iniciado sesión
                    if (wasGuest && currentUser) {
                        showMotivationModal();
                    }

                    // Mostrar modal de reglas de gamificación para nuevos usuarios que han iniciado sesión y no lo han visto
                    if (currentUser && !localStorage.getItem('goatify-gamification-rules-seen')) {
                        setTimeout(() => {
                            dom.gamificationRulesModal.classList.remove('hidden');
                            dom.gamificationRulesModal.classList.add('flex');
                            localStorage.setItem('goatify-gamification-rules-seen', 'true'); // Marcar como visto
                        }, 2000); // Pequeño retraso para una mejor UX
                    }
                } catch (e) {
                    console.error("Error durante finishInitialization:", e);
                    // Mostrar un mensaje de error prominente en la superposición de carga si la inicialización falla
            ...
            // Establecer el idioma y el tema iniciales según el almacenamiento local o la preferencia del sistema
            ...
            /**
             * Desbloquea el contexto de audio para la API de voz web en la primera interacción del usuario.
             * Este es un requisito común en los navegadores para evitar problemas de reproducción automática.
             */
            const unlockAudio = () => {
                const silence = new SpeechSynthesisUtterance('');
                silence.volume = 0; // Reproducir enunciado silencioso
                window.speechSynthesis.speak(silence);
                // Eliminar escuchadores después de la primera interacción
            ...
            // Integración del widget de Netlify Identity
            if (window.netlifyIdentity) {
                // Inicializar en el evento 'init'
                netlifyIdentity.on('init', async (user) => {
    if (user) {
        try {
            currentUserToken = await user.jwt();
            console.log('[Goatify] Token recuperado en init');
        } catch (e) {
            console.warn('[Goatify] No se pudo obtener JWT en init', e);
        }
    }
    finishInitialization(user);
        ...
        try { currentUserToken = await user.jwt(); } catch(e) { console.warn('JWT error', e); }
                    netlifyIdentity.close(); // Cerrar el widget de identidad
                    finishInitialization(user); // Finalizar la inicialización de la aplicación
                });
                // Manejar el cierre de sesión del usuario
                netlifyIdentity.on('logout', () => {
                    // Borrar todo el almacenamiento local relacionado con los datos del usuario al cerrar sesión
                    ...
                    currentUser = null; // Establecer explícitamente currentUser a null
                    resetChatView(); // Restablecer el estado de la interfaz de usuario
                    updateUserUI(); // Actualizar elementos de la interfaz de usuario que dependen del inicio de sesión del usuario
                    showInAppNotification("Sesión Cerrada", "Has cerrado sesión correctamente.", 2000);
                });
                // Manejar errores de Netlify Identity
                netlifyIdentity.on('error', (err) => {
                    console.error("Error de Netlify Identity:", err);
                    if (!initFired) finishInitialization(null); // Volver al modo de invitado si hay un error durante la inicialización inicial
                });
            } else {
                 console.warn("Widget de Netlify Identity no encontrado. Procediendo como invitado.");
                 finishInitialization(null); // Proceder como invitado si el widget no está disponible
            }

            // Fallback para la inicialización de Netlify Identity si el evento 'init' no se activa dentro de un tiempo de espera
            // Esto asegura que la aplicación se cargue incluso si Netlify Identity tarda demasiado o no se activa 'init'.
            setTimeout(() => {
                if (!initFired) {
                    console.warn("El evento 'init' de Netlify Identity no se activó dentro del tiempo de espera. Forzando la inicialización de la aplicación.");
                    finishInitialization(window.netlifyIdentity ? netlifyIdentity.currentUser() : null);
                 }
            }, 3000); // Tiempo de espera de 3 segundos

            // Manejar el botón de retroceso/avance del navegador para la navegación del historial de chat
            window.addEventListener('popstate', (event) => {
                if (event.state && event.state.chatId) {
                    selectChat(event.state.chatId); // Seleccionar chat del estado del historial
                } else {
                    resetChatView(); // Restablecer vista si no hay ID de chat en el estado
                }
            });
    ...
    document.querySelectorAll('.select-plan-btn').forEach(btn=>{
        btn.addEventListener('click', async ()=> {
            ...
            console.log('[Goatify] Click suscripción', plan);
            // Asegúrate de que Netlify Identity esté cargado
            if (!window.netlifyIdentity) {
                alert('Netlify Identity no está disponible.');
                return;
            }
            const user = window.netlifyIdentity.currentUser();
            if (!user) {
                // Si no está logueado, abre el widget de login
            ...
            try {
                ...
                if (data.approvalUrl) {
                    window.location.href = data.approvalUrl; // Redirección a PayPal
                } else {
                    console.error('No se recibió la URL de aprobación.');
                    alert('Error al iniciar el pago. Intenta nuevamente.');
                }
            } catch (err) {
                console.error('[Goatify] Error durante la suscripción:', err);
                alert('No se pudo procesar la suscripción. Vuelve a intentarlo.');
            }
        });
    });
</script>
